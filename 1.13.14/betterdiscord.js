...
var v = (a, e) => () => (a && (e = a(a = 0)), e);
var X = (a, e) => () => (e || a((e = {
        exports: {}
    }).exports, e), e.exports),
    rn = (a, e) => {
        for (var t in e) on(a, t, {
            get: e[t],
            enumerable: !0
        })
    },
    td = (a, e, t, o) => {
        if (e && typeof e == "object" || typeof e == "function")
            for (let r of Am(e)) !Tm.call(a, r) && r !== t && on(a, r, {
                get: () => e[r],
                enumerable: !(o = Im(e, r)) || o.enumerable
            });
        return a
    };
var ze = (a, e, t) => (t = a != null ? Lm(Em(a)) : {}, td(e || !a || !a.__esModule ? on(t, "default", {
        value: a,
        enumerable: !0
    }) : t, a)),
    ad = a => td(on({}, "__esModule", {
        value: !0
    }), a);
var Mm, b, ee = v(() => {
    "use strict";
...
var Dm, M, _e = v(() => {
    "use strict";
    Dm = window.BetterDiscordPreload(), M = Dm
});
var Pm, zm, Bm, Nm, Fm, Om, Rm, Um, jm, qm, Wm, Hm, _m, Vm, rd, nd, Gm, Km, $m, Zm, Xm, Jm, Ym, Qm, eh, th, Be, Oo = v(() => {
    "use strict";
    _e();
    Pm = function(a, e = "utf8") {
        return M.filesystem.readFile(a, e)
    }, zm = function(a, e = "utf8", t) {
        try {
    ...
    }, Ym = (a, e, t) => M.filesystem.watch(a, e, t), Qm = (a, e) => M.filesystem.createWriteStream(a, e), eh = a => M.filesystem.unlinkSync(a), th = a => M.filesystem.unlinkSync(a), Be = {
        readFile: zm,
        exists: _m,
        existsSync: Vm,
        lstat: Gm,
...
var md = X(nn => {
    ...
    var Lt = [],
        ot = [],
        nh = typeof Uint8Array < "u" ? Uint8Array : Array,
        ui = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
    for (Ca = 0, fd = ui.length; Ca < fd; ++Ca) Lt[Ca] = ui[Ca], ot[ui.charCodeAt(Ca)] = Ca;
    var Ca, fd;
    ot[45] = 62;
    ot[95] = 63;
    ...
    function lh(a) {
        return Lt[a >> 18 & 63] + Lt[a >> 12 & 63] + Lt[a >> 6 & 63] + Lt[a & 63]
    }

    function uh(a, e, t) {
        for (var o, r = [], n = e; n < t; n += 3) o = (a[n] << 16 & 16711680) + (a[n + 1] << 8 & 65280) + (a[n + 2] & 255), r.push(lh(o));
        return r.join("")
    }

    function ch(a) {
        for (var e, t = a.length, o = t % 3, r = [], n = 16383, s = 0, d = t - o; s < d; s += n) r.push(uh(a, s, s + n > d ? d : s + n));
        return o === 1 ? (e = a[t - 1], r.push(Lt[e >> 2] + Lt[e << 4 & 63] + "==")) : o === 2 && (e = (a[t - 2] << 8) + a[t - 1], r.push(Lt[e >> 10] + Lt[e >> 4 & 63] + Lt[e << 2 & 63] + "=")), r.join("")
    }
});
var hd = X(ci => {
    ci.read = function(a, e, t, o, r) {
        var n, s, d = r * 8 - o - 1,
            l = (1 << d) - 1,
            u = l >> 1,
            c = -7,
...
var Pd = X(io => {
    ...
    var fi = md(),
        ro = hd(),
        gd = typeof Symbol == "function" && typeof Symbol.for == "function" ? Symbol.for("nodejs.util.inspect.custom") : null;
    io.Buffer = x;
    io.SlowBuffer = bh;
    io.INSPECT_MAX_BYTES = 50;
    var sn = 2147483647;
    io.kMaxLength = sn;
    x.TYPED_ARRAY_SUPPORT = fh();
    ...
    function jt(a) {
        if (a > sn) throw new RangeError('The value "' + a + '" is invalid for option "size"');
    ...
    function vd(a, e, t) {
        ...
        if (ArrayBuffer.isView(a)) return hh(a);
        ...
        if (It(a, ArrayBuffer) || a && It(a.buffer, ArrayBuffer) || typeof SharedArrayBuffer < "u" && (It(a, SharedArrayBuffer) || a && It(a.buffer, SharedArrayBuffer))) return mi(a, e, t);
        ...
        if (o != null && o !== a) return x.from(o, e, t);
        let r = gh(a);
        if (r) return r;
        if (typeof Symbol < "u" && Symbol.toPrimitive != null && typeof a[Symbol.toPrimitive] == "function") return x.from(a[Symbol.toPrimitive]("string"), e, t);
    ...
    function ph(a, e, t) {
        return wd(a), a <= 0 ? jt(a) : e !== void 0 ? typeof t == "string" ? jt(a).fill(e, t) : jt(a).fill(e) : jt(a)
    }
    x.alloc = function(a, e, t) {
        return ph(a, e, t)
    };

    function gi(a) {
        return wd(a), jt(a < 0 ? 0 : bi(a) | 0)
    }
    x.allocUnsafe = function(a) {
        return gi(a)
    };
    x.allocUnsafeSlow = function(a) {
        return gi(a)
    };
    ...
    function pi(a) {
        let e = a.length < 0 ? 0 : bi(a.length) | 0,
            t = jt(e);
    ...
    function hh(a) {
        if (It(a, Uint8Array)) {
            let e = new Uint8Array(a);
            return mi(e.buffer, e.byteOffset, e.byteLength)
        }
        return pi(a)
    }
    ...
    function mi(a, e, t) {
        ...
        let o;
        return e === void 0 && t === void 0 ? o = new Uint8Array(a) : t === void 0 ? o = new Uint8Array(a, e) : o = new Uint8Array(a, e, t), Object.setPrototypeOf(o, x.prototype), o
    }
    ...
    function gh(a) {
        ...
        if (a.length !== void 0) return typeof a.length != "number" || xi(a.length) ? jt(0) : pi(a);
        if (a.type === "Buffer" && Array.isArray(a.data)) return pi(a.data)
    }

    function bi(a) {
        if (a >= sn) throw new RangeError("Attempt to allocate Buffer larger than maximum size: 0x" + sn.toString(16) + " bytes");
        return a | 0
    }

    function bh(a) {
        return +a != a && (a = 0), x.alloc(+a)
    }
    x.isBuffer = function(e) {
        return e != null && e._isBuffer === !0 && e !== x.prototype
    };
    x.compare = function(e, t) {
        if (It(e, Uint8Array) && (e = x.from(e, e.offset, e.byteLength)), It(t, Uint8Array) && (t = x.from(t, t.offset, t.byteLength)), !x.isBuffer(e) || !x.isBuffer(t)) throw new TypeError('The "buf1", "buf2" arguments must be one of type Buffer or Uint8Array');
        if (e === t) return 0;
        let o = e.length,
            r = t.length;
    ...
    x.concat = function(e, t) {
        ...
        let r = x.allocUnsafe(t),
            n = 0;
        for (o = 0; o < e.length; ++o) {
            let s = e[o];
            if (It(s, Uint8Array)) n + s.length > r.length ? (x.isBuffer(s) || (s = x.from(s)), s.copy(r, n)) : Uint8Array.prototype.set.call(r, s, n);
            else if (x.isBuffer(s)) s.copy(r, n);
    ...
    function kd(a, e) {
        if (x.isBuffer(a)) return a.length;
        if (ArrayBuffer.isView(a) || It(a, ArrayBuffer)) return a.byteLength;
    ...
    x.prototype.swap16 = function() {
        ...
        for (let t = 0; t < e; t += 2) Sa(this, t, t + 1);
        return this
    };
    x.prototype.swap32 = function() {
        let e = this.length;
        if (e % 4 !== 0) throw new RangeError("Buffer size must be a multiple of 32-bits");
        for (let t = 0; t < e; t += 4) Sa(this, t, t + 3), Sa(this, t + 1, t + 2);
        return this
    };
    x.prototype.swap64 = function() {
        let e = this.length;
        if (e % 8 !== 0) throw new RangeError("Buffer size must be a multiple of 64-bits");
        for (let t = 0; t < e; t += 8) Sa(this, t, t + 7), Sa(this, t + 1, t + 6), Sa(this, t + 2, t + 5), Sa(this, t + 3, t + 4);
        return this
    };
    x.prototype.toString = function() {
        let e = this.length;
        return e === 0 ? "" : arguments.length === 0 ? Sd(this, 0, e) : yh.apply(this, arguments)
    };
    ...
    x.prototype.inspect = function() {
        let e = "",
            t = io.INSPECT_MAX_BYTES;
        return e = this.toString("hex", 0, t).replace(/(.{2})/g, "$1 ").trim(), this.length > t && (e += " ... "), "<Buffer " + e + ">"
    };
    gd && (x.prototype[gd] = x.prototype.inspect);
    x.prototype.compare = function(e, t, o, r, n) {
        if (It(e, Uint8Array) && (e = x.from(e, e.offset, e.byteLength)), !x.isBuffer(e)) throw new TypeError('The "target" argument must be one of type Buffer or Uint8Array. Received type ' + typeof e);
    ...
    function Cd(a, e, t, o, r) {
        if (a.length === 0) return -1;
        if (typeof t == "string" ? (o = t, t = 0) : t > 2147483647 ? t = 2147483647 : t < -2147483648 && (t = -2147483648), t = +t, xi(t) && (t = r ? 0 : a.length - 1), t < 0 && (t = a.length + t), t >= a.length) {
            if (r) return -1;
            t = a.length - 1
        } else if (t < 0)
            if (r) t = 0;
            else return -1;
        if (typeof e == "string" && (e = x.from(e, o)), x.isBuffer(e)) return e.length === 0 ? -1 : bd(a, e, t, o, r);
        if (typeof e == "number") return e = e & 255, typeof Uint8Array.prototype.indexOf == "function" ? r ? Uint8Array.prototype.indexOf.call(a, e, t) : Uint8Array.prototype.lastIndexOf.call(a, e, t) : bd(a, [e], t, o, r);
    ...
    x.prototype.includes = function(e, t, o) {
        return this.indexOf(e, t, o) !== -1
    };
    x.prototype.indexOf = function(e, t, o) {
        return Cd(this, e, t, o, !0)
    };
    x.prototype.lastIndexOf = function(e, t, o) {
        return Cd(this, e, t, o, !1)
    };
    ...
    function vh(a, e, t, o) {
        return dn(hi(e, a.length - t), a, t, o)
    }

    function wh(a, e, t, o) {
        return dn(zh(e), a, t, o)
    }

    function kh(a, e, t, o) {
        return dn(Dd(e), a, t, o)
    }

    function Ch(a, e, t, o) {
        return dn(Bh(e, a.length - t), a, t, o)
    }
    x.prototype.write = function(e, t, o, r) {
        ...
        for (;;) switch (r) {
            case "hex":
                return xh(this, e, t, o);
            case "utf8":
            case "utf-8":
                return vh(this, e, t, o);
            case "ascii":
            case "latin1":
            case "binary":
                return wh(this, e, t, o);
            case "base64":
                return kh(this, e, t, o);
            case "ucs2":
            case "ucs-2":
            case "utf16le":
            case "utf-16le":
                return Ch(this, e, t, o);
            default:
    ...
    function Sh(a, e, t) {
        return e === 0 && t === a.length ? fi.fromByteArray(a) : fi.fromByteArray(a.slice(e, t))
    }
    ...
    function Lh(a) {
        let e = a.length;
        if (e <= yd) return String.fromCharCode.apply(String, a);
        let t = "",
            o = 0;
        for (; o < e;) t += String.fromCharCode.apply(String, a.slice(o, o += yd));
        return t
    }
    ...
    x.prototype.slice = function(e, t) {
        ...
        return Object.setPrototypeOf(r, x.prototype), r
    };
    ...
    x.prototype.readUintLE = x.prototype.readUIntLE = function(e, t, o) {
        e = e >>> 0, t = t >>> 0, o || Te(e, t, this.length);
        let r = this[e],
            n = 1,
            s = 0;
    ...
    x.prototype.readUintBE = x.prototype.readUIntBE = function(e, t, o) {
        e = e >>> 0, t = t >>> 0, o || Te(e, t, this.length);
        let r = this[e + --t],
            n = 1;
    ...
    x.prototype.readBigUInt64LE = ua(function(e) {
        e = e >>> 0, no(e, "offset");
        let t = this[e],
            o = this[e + 7];
        (t === void 0 || o === void 0) && Uo(e, this.length - 8);
        let r = t + this[++e] * 2 ** 8 + this[++e] * 2 ** 16 + this[++e] * 2 ** 24,
            n = this[++e] + this[++e] * 2 ** 8 + this[++e] * 2 ** 16 + o * 2 ** 24;
        return BigInt(r) + (BigInt(n) << BigInt(32))
    });
    x.prototype.readBigUInt64BE = ua(function(e) {
        e = e >>> 0, no(e, "offset");
        let t = this[e],
            o = this[e + 7];
        (t === void 0 || o === void 0) && Uo(e, this.length - 8);
    ...
    x.prototype.readIntLE = function(e, t, o) {
        e = e >>> 0, t = t >>> 0, o || Te(e, t, this.length);
        let r = this[e],
            n = 1,
            s = 0;
    ...
    x.prototype.readIntBE = function(e, t, o) {
        e = e >>> 0, t = t >>> 0, o || Te(e, t, this.length);
        let r = t,
            n = 1,
            s = this[e + --r];
    ...
    x.prototype.readBigInt64LE = ua(function(e) {
        e = e >>> 0, no(e, "offset");
        let t = this[e],
            o = this[e + 7];
        (t === void 0 || o === void 0) && Uo(e, this.length - 8);
    ...
    x.prototype.readBigInt64BE = ua(function(e) {
        e = e >>> 0, no(e, "offset");
        let t = this[e],
            o = this[e + 7];
        (t === void 0 || o === void 0) && Uo(e, this.length - 8);
    ...
    x.prototype.readFloatLE = function(e, t) {
        return e = e >>> 0, t || Te(e, 4, this.length), ro.read(this, e, !0, 23, 4)
    };
    x.prototype.readFloatBE = function(e, t) {
        return e = e >>> 0, t || Te(e, 4, this.length), ro.read(this, e, !1, 23, 4)
    };
    x.prototype.readDoubleLE = function(e, t) {
        return e = e >>> 0, t || Te(e, 8, this.length), ro.read(this, e, !0, 52, 8)
    };
    x.prototype.readDoubleBE = function(e, t) {
        return e = e >>> 0, t || Te(e, 8, this.length), ro.read(this, e, !1, 52, 8)
    };

    function Ve(a, e, t, o, r, n) {
        if (!x.isBuffer(a)) throw new TypeError('"buffer" argument must be a Buffer instance');
        if (e > r || e < n) throw new RangeError('"value" argument is out of bounds');
        if (t + o > a.length) throw new RangeError("Index out of range")
    }
    x.prototype.writeUintLE = x.prototype.writeUIntLE = function(e, t, o, r) {
    ...
    x.prototype.writeUintBE = x.prototype.writeUIntBE = function(e, t, o, r) {
        if (e = +e, t = t >>> 0, o = o >>> 0, !r) {
            let d = Math.pow(2, 8 * o) - 1;
            Ve(this, e, t, o, d, 0)
        }
    ...
    x.prototype.writeUint8 = x.prototype.writeUInt8 = function(e, t, o) {
        return e = +e, t = t >>> 0, o || Ve(this, e, t, 1, 255, 0), this[t] = e & 255, t + 1
    };
    x.prototype.writeUint16LE = x.prototype.writeUInt16LE = function(e, t, o) {
        return e = +e, t = t >>> 0, o || Ve(this, e, t, 2, 65535, 0), this[t] = e & 255, this[t + 1] = e >>> 8, t + 2
    };
    x.prototype.writeUint16BE = x.prototype.writeUInt16BE = function(e, t, o) {
        return e = +e, t = t >>> 0, o || Ve(this, e, t, 2, 65535, 0), this[t] = e >>> 8, this[t + 1] = e & 255, t + 2
    };
    x.prototype.writeUint32LE = x.prototype.writeUInt32LE = function(e, t, o) {
        return e = +e, t = t >>> 0, o || Ve(this, e, t, 4, 4294967295, 0), this[t + 3] = e >>> 24, this[t + 2] = e >>> 16, this[t + 1] = e >>> 8, this[t] = e & 255, t + 4
    };
    x.prototype.writeUint32BE = x.prototype.writeUInt32BE = function(e, t, o) {
        return e = +e, t = t >>> 0, o || Ve(this, e, t, 4, 4294967295, 0), this[t] = e >>> 24, this[t + 1] = e >>> 16, this[t + 2] = e >>> 8, this[t + 3] = e & 255, t + 4
    };

    function Ld(a, e, t, o, r) {
        Md(e, o, r, a, t, 7);
    ...
    x.prototype.writeBigUInt64LE = ua(function(e, t = 0) {
        return Ld(this, e, t, BigInt(0), BigInt("0xffffffffffffffff"))
    });
    x.prototype.writeBigUInt64BE = ua(function(e, t = 0) {
        return Id(this, e, t, BigInt(0), BigInt("0xffffffffffffffff"))
    });
    x.prototype.writeIntLE = function(e, t, o, r) {
        if (e = +e, t = t >>> 0, !r) {
    ...
    x.prototype.writeIntBE = function(e, t, o, r) {
        if (e = +e, t = t >>> 0, !r) {
            let l = Math.pow(2, 8 * o - 1);
            Ve(this, e, t, o, l - 1, -l)
        }
    ...
    x.prototype.writeInt8 = function(e, t, o) {
        return e = +e, t = t >>> 0, o || Ve(this, e, t, 1, 127, -128), e < 0 && (e = 255 + e + 1), this[t] = e & 255, t + 1
    };
    x.prototype.writeInt16LE = function(e, t, o) {
        return e = +e, t = t >>> 0, o || Ve(this, e, t, 2, 32767, -32768), this[t] = e & 255, this[t + 1] = e >>> 8, t + 2
    };
    x.prototype.writeInt16BE = function(e, t, o) {
        return e = +e, t = t >>> 0, o || Ve(this, e, t, 2, 32767, -32768), this[t] = e >>> 8, this[t + 1] = e & 255, t + 2
    };
    x.prototype.writeInt32LE = function(e, t, o) {
        return e = +e, t = t >>> 0, o || Ve(this, e, t, 4, 2147483647, -2147483648), this[t] = e & 255, this[t + 1] = e >>> 8, this[t + 2] = e >>> 16, this[t + 3] = e >>> 24, t + 4
    };
    x.prototype.writeInt32BE = function(e, t, o) {
        return e = +e, t = t >>> 0, o || Ve(this, e, t, 4, 2147483647, -2147483648), e < 0 && (e = 4294967295 + e + 1), this[t] = e >>> 24, this[t + 1] = e >>> 16, this[t + 2] = e >>> 8, this[t + 3] = e & 255, t + 4
    };
    x.prototype.writeBigInt64LE = ua(function(e, t = 0) {
        return Ld(this, e, t, -BigInt("0x8000000000000000"), BigInt("0x7fffffffffffffff"))
    });
    x.prototype.writeBigInt64BE = ua(function(e, t = 0) {
        return Id(this, e, t, -BigInt("0x8000000000000000"), BigInt("0x7fffffffffffffff"))
    });

    function Ad(a, e, t, o, r, n) {
        if (t + o > a.length) throw new RangeError("Index out of range");
        if (t < 0) throw new RangeError("Index out of range")
    }

    function Ed(a, e, t, o, r) {
        return e = +e, t = t >>> 0, r || Ad(a, e, t, 4, 34028234663852886e22, -34028234663852886e22), ro.write(a, e, t, o, 23, 4), t + 4
    }
    x.prototype.writeFloatLE = function(e, t, o) {
        return Ed(this, e, t, !0, o)
    };
    x.prototype.writeFloatBE = function(e, t, o) {
        return Ed(this, e, t, !1, o)
    };

    function Td(a, e, t, o, r) {
        return e = +e, t = t >>> 0, r || Ad(a, e, t, 8, 17976931348623157e292, -17976931348623157e292), ro.write(a, e, t, o, 52, 8), t + 8
    }
    x.prototype.writeDoubleLE = function(e, t, o) {
        return Td(this, e, t, !0, o)
    };
    x.prototype.writeDoubleBE = function(e, t, o) {
        return Td(this, e, t, !1, o)
    };
    x.prototype.copy = function(e, t, o, r) {
    ...
    x.prototype.fill = function(e, t, o, r) {
        if (typeof e == "string") {
            ...
            if (typeof r == "string" && !x.isEncoding(r)) throw new TypeError("Unknown encoding: " + r);
            if (e.length === 1) {
        ...
        if (typeof e == "number")
            ...
            let s = x.isBuffer(e) ? e : x.from(e, r),
                d = s.length;
    ...
    yi("ERR_BUFFER_OUT_OF_BOUNDS", function(a) {
        return a ? `${a} is outside of buffer bounds` : "Attempt to access memory outside buffer bounds"
    }, RangeError);
    yi("ERR_INVALID_ARG_TYPE", function(a, e) {
        return `The "${a}" argument must be of type number. Received type ${typeof e}`
    }, TypeError);
    yi("ERR_OUT_OF_RANGE", function(a, e, t) {
        let o = `The value of "${a}" is out of range.`,
            r = t;
        return Number.isInteger(t) && Math.abs(t) > 2 ** 32 ? r = xd(String(t)) : typeof t == "bigint" && (r = String(t), (t > BigInt(2) ** BigInt(32) || t < -(BigInt(2) ** BigInt(32))) && (r = xd(r)), r += "n"), o += ` It must be ${e}. Received ${r}`, o
    }, RangeError);
    ...
    function Mh(a, e, t) {
        no(e, "offset"), (a[e] === void 0 || a[e + t] === void 0) && Uo(e, a.length - (t + 1))
    }

    function Md(a, e, t, o, r, n) {
        if (a > t || a < e) {
            let s = typeof e == "bigint" ? "n" : "",
                d;
            throw n > 3 ? e === 0 || e === BigInt(0) ? d = `>= 0${s} and < 2${s} ** ${(n+1)*8}${s}` : d = `>= -(2${s} ** ${(n+1)*8-1}${s}) and < 2 ** ${(n+1)*8-1}${s}` : d = `>= ${e}${s} and <= ${t}${s}`, new oo.ERR_OUT_OF_RANGE("value", d, a)
        }
        Mh(o, r, n)
    }

    function no(a, e) {
        if (typeof a != "number") throw new oo.ERR_INVALID_ARG_TYPE(e, "number", a)
    }

    function Uo(a, e, t) {
        throw Math.floor(a) !== a ? (no(a, t), new oo.ERR_OUT_OF_RANGE(t || "offset", "an integer", a)) : e < 0 ? new oo.ERR_BUFFER_OUT_OF_BOUNDS : new oo.ERR_OUT_OF_RANGE(t || "offset", `>= ${t?1:0} and <= ${e}`, a)
    }
    var Dh = /[^+/0-9A-Za-z-_]/g;

    function Ph(a) {
        if (a = a.split("=")[0], a = a.trim().replace(Dh, ""), a.length < 2) return "";
...
var jo, V, qe = v(() => {
    "use strict";
    jo = ze(require("path"), 1);
    At();
    V = new class extends ye {
        data = {
            branch: "main",
            commit: "acb982f4",
            build: "production",
            ...
            dataPath: jo.default.join(process.env.BETTERDISCORD_DATA_PATH, "data"),
            pluginsPath: jo.default.join(process.env.BETTERDISCORD_DATA_PATH, "plugins"),
            themesPath: jo.default.join(process.env.BETTERDISCORD_DATA_PATH, "themes"),
            channelPath: jo.default.join(process.env.BETTERDISCORD_DATA_PATH, "data", window?.DiscordNative?.app?.getReleaseChannel?.() ?? "stable")
        };
        get(e) {
            return this.data[e]
        }
...
var Rd, F, Ne = v(() => {
    "use strict";
    Rd = ze(require("events"), 1), F = new class extends Rd.default {
        constructor() {
...
function _d(a) {
    ...
    for (let t = 0; t < a.length; t++) {
        let o = a[t];
        typeof o != "object" || o === null ? e[t] = o : Array.isArray(o) ? e[t] = _d(o) : e[t] = qt({}, o)
    }
    return e
}
    ...
    for (let t = 0; t < e.length; t++) {
        ...
        if (!Rh(o))
            for (let r in o) {
                ...
                let n = a[r],
                    s = o[r];
                s !== a && (typeof s != "object" || s === null ? a[r] = s : Array.isArray(s) ? a[r] = _d(s) : typeof n != "object" || n === null || Array.isArray(n) ? a[r] = qt({}, s) : a[r] = qt(n, s))
            }
    }
    return a
}
...
function ve(a, e, {
    ...
    if (a instanceof Array) {
        ...
        for (let s of n)
            if (!(typeof a[s] > "u" || o.includes(s)) && (r = ve(a[s], e, {
                    walkable: t,
                    ignore: o
                }), typeof r < "u")) return r
    }
...
function fo(a) {
    let e = a.split("/**", 2)[1].split("*/", 1)[0],
        t = {},
        o = "",
        r = "";
    for (let n of e.split(Uh))
        if (n.length !== 0)
            if (n.charAt(0) === "@" && n.charAt(1) !== " ") {
                t[o] ? (Array.isArray(t[o]) || (t[o] = [t[o]]), t[o].push(r.trim())) : t[o] = r.trim();
                let s = n.indexOf(" ");
                o = n.substring(1, s), r = n.substring(s + 1)
            } else r += " " + n.replace("\\n", `
`).replace(jh, "@");
    return t[o] ? (Array.isArray(t[o]) || (t[o] = [t[o]]), t[o].push(r.trim())) : t[o] = r.trim(), delete t[""], t.format = "jsdoc", t
}
var Uh, jh, Xd = v(() => {
    "use strict";
    Uh = /[^\S\r\n]*?\r?(?:\r\n|\n)[^\S\r\n]*?\*[^\S\r\n]?/, jh = /^\\@/
...
var q, Et = v(() => {
    ...
    q = class {
        ...
        static pushChildPatch(e, t, o, r, n = {}) {
            ...
            let c = `${n.displayName||l.displayName||l.name||l.constructor?.displayName||l.constructor?.name||"anonymous"}.${o}`,
...
function nt(a) {
    return !!(!(typeof a == "object" || typeof a == "function") || !a || a.TypedArray || a === window || a === document.documentElement || a[Symbol.toStringTag] === "DOMTokenList" || a === Symbol || a instanceof Window || a instanceof Wh || a.$$loader && a.$$baseObject || a.Z?.$$loader && a.Z?.$$baseObject)
}
...
var pn, La, qh, Wh, Tt, mn = v(() => {
    "use strict";
    ee();
    pn = new WeakSet, La = a => Object.assign((e, t, o) => {
        try {
            ...
            return pn.has(a) || b.warn("WebpackModules~getModule", "Module filter threw an exception.", r, {
                filter: a,
                module: t
            }), pn.add(a), !1
        }
        ...
        __originalFilter: a
    }), qh = a => Object.assign(e => {
        try {
            return a(e)
        } catch (t) {
            return pn.has(a) || b.warn("WebpackModules~getModule", "Declaration filter threw an exception.", t, {
                filter: a
            }), pn.add(a), !1
        }
    }, {
    ...
    Wh = Object.getPrototypeOf(Uint8Array);
    Tt = () => new Error("Module search failed!")
});
var ki, mt, Ci = v(() => {
    "use strict";
    Oo();
    ki = ze(require("path"), 1);
    qe();
    mt = class {
        static data;
        static get(e) {
        ...
        static load() {
            let e = ki.default.resolve(V.get("channelPath"), "webpack.json");
            try {
                let t = Be.readFileSync(e).toString();
        ...
        static save() {
            let e = ki.default.resolve(V.get("channelPath"), "webpack.json");
            Be.writeFileSync(e, JSON.stringify(this.data, null, 4))
        }
...
function Si(a, e, t) {
    ...
    if (nt(a.exports)) return;
    if (e(a.exports, a, a.id)) return t.declarationFilter ? rt(a, t.declarationFilter) : s ? a : a.exports;
    if (!r && !n) return;
    let d, l = [];
    r ? l.push(...Object.keys(a.exports)) : n && (d = Ia(a)) && l.push(d);
    for (let u = 0; u < l.length; u++) {
        let c = l[u],
            f = a.exports[c];
        if (!nt(f) && e(f, a, a.id)) return t.declarationFilter ? rt(a, t.declarationFilter) : !o && d === c ? a.exports : s ? a : f
    }
}
...
function po(a, e = {}) {
    ...
    for (let u = 0; u < l.length; u++) {
        let c = l[u];
        if (nt(c.exports)) continue;
        if (a(c.exports, c, c.id))
            if (e.declarationFilter) {
                let h = rt(c, e.declarationFilter);
                h && d.push(h)
            } else d.push(n ? c : c.exports);
        if (!o && !r) continue;
        let f, m = [];
        o ? m.push(...Object.keys(c.exports)) : r && (f = Ia(c)) && m.push(f);
        for (let h = 0; h < m.length; h++) {
            let g = m[h],
                y = c.exports[g];
            if (!nt(y) && a(y, c, c.id)) {
                if (e.declarationFilter) {
                    let I = rt(c, e.declarationFilter);
                    I && d.push(I);
                    continue
                }
                if (!t && f === g) {
...
function el(a) {
    for (let e in a) {
        if (!Reflect.has(a, e) || Reflect.has(_.c, e)) continue;
        let t = a[e],
            o = (n, s, d) => {
                try {
                    let l = [...hn];
...
function Jd() {
    Li++, go && (clearTimeout(go), go = null)
}

function qo() {
    Li--, !(Li > 0) && (go && clearTimeout(go), go = setTimeout(() => {
        _h(), q.unpatchAll("WebpackRequire")
    }, 50))
}

function Vh(a) {
    q.after("WebpackRequire", a, "e", (e, t, o) => {
        Jd(), o.finally(qo)
    }), q.before("WebpackRequire", a, "l", (e, t) => {
        Jd();
        let o = t[1];
        t[1] = function(r) {
            qo(), o.call(this, r)
...
function Yd(a) {
    let [, e] = a;
    return el(e), Reflect.apply(Qd, window.webpackChunkdiscord_app, [a])
}
var _, hn, Qd, Hh, _h, tl, Li, go, gn, ho = v(() => {
    "use strict";
    ee();
    Et();
    mo();
    hn = new Set, Qd = (window.webpackChunkdiscord_app ??= []).push;
    Object.defineProperty(window.webpackChunkdiscord_app, "push", {
        configurable: !0,
        get: () => Yd,
        set: a => {
            Qd = a, Object.defineProperty(window.webpackChunkdiscord_app, "push", {
                value: Yd,
                configurable: !0,
                writable: !0
            })
    ...
    ({
        promise: Hh,
        resolve: _h
    } = Promise.withResolvers()), tl = Hh, Li = 1, go = null;
    window.webpackChunkdiscord_app.push([
        [Symbol("BetterDiscord")], {},
        a => {
            "b" in a && (_ = a, el(a.m), Vh(a))
        }
    ]);
    if (performance.getEntriesByName("app_first_render_after_ready_payload").length > 0) qo();
    else {
...
function Ai(a) {
    return Wt(e => e && e.displayName === a, {
        name: a
    })
}

function Gh(a) {
    return Wt(e => e?._dispatchToken && e?.getName?.() === a, {
        name: a
    })
}

function Kh(...a) {
    return Wt((e, t, o) => a.every(r => r(e, t, o)), {
        filters: a
    })
}

function $h(a) {
    return Wt((e, t, o) => !a(e, t, o), {
        filter: a
    })
}
var xn = v(() => {
...
function Fe(a, e = {}) {
    ...
    if (e.cacheId || (e.cacheId = null), t?.aborted) return d ? Promise.reject(Tt()) : Promise.resolve(void 0);
    ...
    return u ? Promise.resolve(u) : (a = La(a), new Promise((c, f) => {
        let m = () => void hn.delete(h),
            h = (g, y) => {
                if (nt(y.exports)) return;
                if (a(y.exports, y, y.id)) {
                    c(l ? rt(y, l) : s ? y : y.exports), m();
                    return
                }
                if (!n && !r) return;
                let I, R = [];
                n ? R.push(...Object.keys(y.exports)) : r && (I = Ia(y)) && R.push(I);
        ...
        hn.add(h), t?.addEventListener("abort", () => {
            m(), d ? f(Tt()) : c(void 0)
        })
    }))
}
async function rl(a) {
    if (typeof _.m[a] > "u") return [];
    let e = String(_.m[a]),
        t = [],
        o;
    for (;
        ...
        let f = parseInt(l, 10);
        await Promise.all(u.map(h => _.e(h)));
        let m = _(f);
        t.push(m)
    }
    let r = [],
        n;
    for (;
        (n = ol.exec(e)) !== null;) r.push(n[1]);
    let s = e.matchAll(Zh);
    for (let d of s) {
        await Promise.all(r.map(u => _.e(u)));
        let l = _(d[1]);
        t.push(l)
    }
    return t
...
var ol, Zh, Xh, vn = v(() => {
    ...
    ho();
    mn();
    ol = /n\.e\("(\d+)"\)/g, Zh = /n\.bind\(n,\s*(\d+)\s*\)/g, Xh = /createPromise:\s*\(\)\s*=>\s*([^}]+)\.then\(n\.bind\(n,\s*(\d+)\)\)/g
});
...
function Mt(a, e) {
    ...
    for (let n = 0; n < o.length; n++) {
        ...
        if (Object.prototype.hasOwnProperty.call(a, s))
            for (let d = 0; d < r.length; d++) {
                let l = r[d];
                Object.prototype.hasOwnProperty.call(e, l) && (Object.prototype.hasOwnProperty.call(t, l) || e[l](a[s], s) && Object.defineProperty(t, l, {
                    get() {
                        return a[s]
                    },
                    set(u) {
    ...
    return Object.defineProperty(t, Symbol("betterdiscord.mapObject"), {
        value: {
            module: a,
            mappers: e
        },
...
function* Dt(a, {
    ...
    yield e ??= ne(o => Object.values(o).some(a), t), yield e && Object.keys(e).find(o => a(e[o]))
}
...
function Mi(a, e = {}) {
    ...
    if (!nt(r?.exports)) return t ? r : r.exports;
    if (o) throw Tt()
}
...
function Di(...a) {
    ...
    for (let n = 0; n < a.length; n++) {
        let s = a[n],
            d = n in e;
        if (s.fatal) {
            if (s.all && (!Array.isArray(e[n]) || e[n].length === 0)) throw Tt();
            if (!d) throw Tt()
        }
        s.map && !d && (e[n] = {})
    }
...
function Aa(a) {
    return fa || (fa = ne(e => e.Store?.getAll, {
        firstId: 311907,
        cacheId: "core-stores-Flux"
    })), fa ? fa.Store.getAll().find(e => e.getName() === a) : ne(N.byStoreName(a))
}
var fa, Me, cl = v(() => {
    "use strict";
    ce();
    Me = new Proxy({}, {
        ownKeys() {
            return fa || (fa = ne(a => a.Store?.getAll, {
                firstId: 311907,
                cacheId: "core-stores-Flux"
            })), fa ? [...new Set(fa.Store.getAll().map(a => a.getName()).filter(a => a.length > 3))] : []
        },
        getOwnPropertyDescriptor() {
            return {
                enumerable: !0,
        ...
        get(a, e) {
            return typeof a[e] > "u" ? a[e] = Aa(e) : a[e]
        },
        set() {
...
var fl, Jh, Yh, C, Z = v(() => {
    ...
    fl = kn({
        React: {
            filter: N.byKeys(["createElement", "cloneElement"]),
            firstId: 483362,
            cacheId: "core-React"
        },
        ReactSpring: {
            filter: N.byKeys(["useTransition", "animated"]),
            firstId: 429783,
            cacheId: "core-ReactSpring"
        },
        SimpleMarkdown: {
            filter: N.byKeys(["defaultReactOutput"]),
            firstId: 791332,
            searchExports: !0,
            cacheId: "core-SimpleMarkdown"
        },
        Dispatcher: {
            filter: N.byKeys(["dispatch", "subscribe", "register"]),
            searchExports: !0,
            firstId: 570140,
            cacheId: "core-Dispatcher"
        },
        Tooltip: {
            filter: N.byPrototypeKeys(["renderTooltip"]),
            searchExports: !0,
            firstId: 481060,
        ...
        ChannelActions: {
            filter: N.byKeys(["selectPrivateChannel"]),
            firstId: 287734,
            cacheId: "core-ChannelActions"
        }
    });
    fl.Tooltip ??= a => a.children?.({}) ?? null;
    Jh = fn({
        get InviteActions() {
        ...
        get promptToUpload() {
            return Pt(["getUploadCount", ".UPLOAD_FILE_LIMIT_ERROR"], {
                searchExports: !0,
                firstId: 518960,
        ...
        get LinkParser() {
            return ne(a => a.html && a.requiredFirstCharacters?.[0] === "[", {
                firstId: 694403,
                cacheId: "core-LinkParser"
            })
        },
        get DiscordMarkdown() {
            return ne(a => a?.prototype?.render && a.rules, {
                firstId: 558179,
                cacheId: "core-DiscordMarkdown"
            })
        },
        get Layout() {
            return dl(["$Root", "buildLayout"], {
                searchDefault: !1,
                firstId: 419954,
                cacheId: "core-Layout"
            })
    ...
    }), Yh = Object.assign(Jh, fl), C = Yh
});
var Qh, eg, tg, ht, bo = v(() => {
    "use strict";
    ce();
    Qh = te(["createPortal"], {
        firstId: 340287,
    ...
    }), tg = Object.assign({}, Qh, eg), ht = tg
});
var pl, i, Ho, ml, LC, hl, IC, gl, _o, AC, Cn, EC, bl, TC, it, Sn, MC, DC, PC, zC, BC, Ln, In, yl, xl, pa, _t, NC, FC, A = v(() => {
    "use strict";
    Z();
    bo();
    pl = C.React, i = pl, Ho = ht, {
        Children: ml,
        Component: LC,
        Fragment: hl,
        cloneElement: IC,
...
var An, Q, zt = v(() => {
    "use strict";
    Oo();
    An = ze(require("path"), 1);
    At();
    qe();
    ee();
    A();
    Q = new class extends ye {
        cache = {
            settings: void 0,
            plugins: void 0,
            themes: void 0,
        ...
        #e(e) {
            ...
            let t;
            try {
                t = JSON.parse(Be.readFileSync(An.default.resolve(V.get("channelPath"), `${e}.json`)).toString())
            } catch {
                t = {}
            }
            return t
        ...
        #t(e) {
            Be.writeFileSync(An.default.resolve(V.get("channelPath"), `${e}.json`), JSON.stringify(this.cache[e], null, 4)), this.emitChange()
        }
        #a(e) {
            return An.default.resolve(V.get("pluginsPath"), e + ".config.json")
        }
        #o(e) {
            if (!(typeof this.pluginCache[e] < "u")) {
                if (!Be.existsSync(this.#a(e))) return this.pluginCache[e] = {};
                try {
                    this.pluginCache[e] = JSON.parse(Be.readFileSync(this.#a(e)).toString())
                } catch {
        ...
        recache(e) {
            ...
            try {
                return this.pluginCache[e] = JSON.parse(Be.readFileSync(this.#a(e)).toString()), this.emitChange(), !0
            } catch (o) {
        ...
        #r(e) {
            Be.writeFileSync(this.#a(e), JSON.stringify(this.pluginCache[e], null, 4)), this.emitChange()
        }
        getData(e, t) {
            return this.#o(e), this.pluginCache[e][t]
        }
        useData(e, t) {
            let [o, r] = _t(() => this.getData(e, t));
            return Ln(() => {
...
function Ea(a) {
    return typeof a == "string" || eu(a)
}

function Ng(a) {
    return Object.keys(zi).includes(a)
}
var Bi, Vt, yo, gt, bt, Ni, p, G = v(() => {
    "use strict";
    Ql();
    Je();
    ee();
    Bi = new Map, bt = {
        ...
        get rules() {
            return Bi.get(bt.locale)
        },
        get supportedLocales() {
            return gt ? Object.keys(gt) : []
        },
        isSupported(a) {
            return gt ? Object.keys(gt).includes(a) : !1
        },
        init(a) {
            let {
                locale: e,
            ...
            if (!Ng(t)) throw new Error(`Invalid fallback locale: ${t}`);
            yo = t, gt = o, bt.setLocale(e ?? t)
        },
        setLocale(a) {
            bt.isSupported(a) || (b.warn("i18n", `Locale ${a} is not supported, falling back to ${yo}`), a = yo), Vt = a, !Bi.has(Vt) && Bi.set(Vt, new Intl.PluralRules(Vt))
        },
        pluralize(a, e) {
            ...
            let o = "zero" in a && e === 0 ? "zero" : bt.rules?.select(e);
            return o ? o in a && a[o] ? a[o] : a.other ?? a.one ?? `Missing plural form: ${o}` : (b.warn("i18n", `No plural selection for ${Vt} with count ${e}`), a.other ?? a.one ?? "Translation error")
        },
        context(a, e) {
            let t = `${a}.${e}`,
                o = `${a}.default`,
                r = e ? pt(gt[Vt], t) : null;
            if (Ea(r) || (r = pt(gt[Vt], o)), Ea(r) || (r = e ? pt(gt[yo], t) : null, Ea(r) || (r = pt(gt[yo], o)), Ea(r))) return r
        },
        t(a, e, t) {
            let o = bt.context(a, e?.context);
            if (Ea(o) || (o = pt(gt[Vt], a)), Ea(o) || (o = pt(gt[yo], a)), !Ea(o)) return "String not found!";
            if (eu(o) && (o = bt.pluralize(o, e?.count)), e) {
                let r = {
                    ...e
                };
                for (let n in t)
...
var tu, En, Fi = v(() => {
    tu = a => a.replace(/([a-z0-9])([A-Z])/g, "$1-$2").toLowerCase(), En = (...a) => a.filter((e, t, o) => !!e && e.trim() !== "" && o.indexOf(e) === t).join(" ").trim()
});
var au, ou = v(() => {
    au = {
...
var Ta, Oi = v(() => {
    ...
    Ta = Cn(({
        ...
        className: En("lucide", r),
        ...d
    }, [...s.map(([u, c]) => _o(u, c)), ...Array.isArray(n) ? n : [n]]))
});
var S, U = v(() => {
    A();
    Fi();
...
var k, me = v(() => {
    ...
    At();
    oe();
    k = new class extends ye {
        state = {};
        collections = [];
        panels = [];
        initialize() {
            this.registerCollection("settings", "Settings", jd)
        }
                    ...
                    if (Object.defineProperties(u, {
                        ...
                        for (let g of u.options) {
                            ...
                            Object.defineProperty(g, "label", {
                                enumerable: !0,
                                get: () => p(`Collections.${t.id}.${s.id}.${u.id}.options.${g.id??g.value}`) || y
                            })
                        }
        ...
        onSettingChange(e, t, o, r) {
            this.state[e][t][o] = r, F.dispatch("setting-updated", e, t, o, r), this.emitChange(), this.saveCollection(e)
        }
        getSetting(e, t, o) {
        ...
        on(e, t, o, r) {
            ...
            return F.on("setting-updated", n), () => {
                F.off("setting-updated", n)
            }
        }
    }
});
var W, et = v(() => {
    ...
    me();
    ee();
    W = new class extends ye {
        _toasts = [];
        toastKey = 0;
        get shouldShowToasts() {
            return k.get("settings", "general", "showToasts")
        }
        addToast(e) {
...
var Xu, Ju, Yu, Qu, ec, tc, ac, oc, rc, nc, ic, sc, dc, lc, uc, cc, Ui, fc, pc = v(() => {
    "use strict";
    Xu = "bd-window-minimize", Ju = "bd-window-maximize", Yu = "bd-relaunch-app", Qu = "bd-run-script", ec = "bd-did-navigate-in-page", tc = "bd-open-devtools", ac = "bd-close-devtools", oc = "bd-toggle-devtools", rc = "bd-open-window", nc = "bd-inspect-element", ic = "bd-minimum-size", sc = "bd-window-size", dc = "bd-remove-devtools-message", lc = "bd-open-dialog", uc = "bd-get-accent-color", cc = "bd-open-path", Ui = "bd-set-allow-preload-override", fc = "bd-get-allow-preload-override"
});
var Se, J, De = v(() => {
    "use strict";
    Se = require("electron");
    ...
    J = new class {
        constructor() {
            Se.ipcRenderer.on(ec, () => F.dispatch("navigate")), Se.ipcRenderer.on(Ju, () => F.dispatch("maximize")), Se.ipcRenderer.on(Xu, () => F.dispatch("minimize"))
        }
        openDevTools() {
            return Se.ipcRenderer.send(tc)
        }
        closeDevTools() {
            return Se.ipcRenderer.send(ac)
        }
        toggleDevTools() {
            return Se.ipcRenderer.send(oc)
        }
        relaunch(e) {
            return Se.ipcRenderer.send(Yu, e)
        }
        runScript(e) {
            return Se.ipcRenderer.invoke(Qu, e)
        }
        openWindow(e, t) {
            return Se.ipcRenderer.invoke(rc, e, t)
        }
        inspectElement() {
            return Se.ipcRenderer.send(nc)
        }
        setMinimumSize(e, t) {
            return Se.ipcRenderer.send(ic, e, t)
        }
        setWindowSize(e, t) {
            return Se.ipcRenderer.send(sc, e, t)
        }
        stopDevtoolsWarning() {
            return Se.ipcRenderer.send(dc)
        }
        openDialog(e) {
            return Se.ipcRenderer.invoke(lc, e)
        }
        getSystemAccentColor() {
            return Se.ipcRenderer.invoke(uc)
        }
        openPath(e) {
            return Se.ipcRenderer.send(cc, e)
        }
        allowPreloadOverride = {
            async set(e) {
                await Se.ipcRenderer.invoke(Ui, e)
            },
            async get() {
                return Se.ipcRenderer.invoke(fc)
            },
            async toggle() {
                await Se.ipcRenderer.invoke(Ui, !await this.get())
            }
        }
    }
});
var P, He = v(() => {
    ...
    P = class {
        ...
        static injectTheme(e, t) {
            e = this.escapeID(e);
            let o = document.getElementById(e) || this.createElement("style", {
                id: e
            });
...
var Tb, Le, Ft = v(() => {
    ...
    He();
    G();
    Tb = /@property\s+--([A-Za-z0-9-_]+)\s*\{(.+?)\}/gs;
    Le = new class extends Na {
        name = "ThemeManager";
        extension = ".theme.css";
        duplicatePattern = /\.theme\s?\([0-9]+\)\.css/;
        addonFolder = V.get("themesPath");
        prefix = "theme";
        language = "css";
        order = 4;
        loadAddons() {
            for (let e of this.addonInfo) this.loadAddon(e);
            this.finishInit()
        }
        initAddon(e) {
            let t = e;
        ...
        startAddon(e) {
            let t = this.resolveAddon(e);
            t && (P.injectTheme(t.slug + "-theme-container", t.css), this.hasInitialized ? W.success(p("Addons.enabled", {
                name: t.name,
                version: t.version
            })) : this.initialAddonsLoaded++)
        }
        stopAddon(e) {
            let t = this.resolveAddon(e);
            t && (P.removeTheme(t.slug + "-theme-container"), W.error(p("Addons.disabled", {
                name: t.name,
                version: t.version
            })))
        }
        extractCustomProperties(e) {
            let t = {},
                o = e.matchAll(Tb);
            for (let r of o) r.length === 3 && (t[r[1]] = Mb(r[2]));
            return t
        }
    }
});
var Db, br, hc = v(() => {
    ...
    me();
    _e();
    Db = /^betterdiscord:\/\/editor\/(?:custom-css|(theme|plugin)\/([^/]+))\/?/, br = new class extends ye {
        constructor() {
            super(), this.listener = this.listener.bind(this), k.addChangeListener(this.listener), Me.ThemeStore?.addChangeListener(this.listener), Me.AccessibilityStore?.addChangeListener(this.listener), this.listener(), M.editor.onLiveUpdateChange(e => {
                k.set("settings", "customcss", "liveUpdate", e)
            }), M.addProtocolListener(e => {
                let t = e.match(Db);
                if (t)
                    if (t[1] === void 0) {
                        if (!k.get("settings", "customcss", "customcss")) return;
                        M.editor.open("custom-css")
                    } else(t[1] === "theme" ? (Ft(), ad(mc)) : (tt(), ad(gc))).default.isLoaded(t[2]) && M.editor.open(t[1], t[2])
            })
        }
        listener() {
            M.editor.updateSettings({
                options: this.getEditorOptions(),
                liveUpdate: k.get("settings", "customcss", "liveUpdate"),
                discordTheme: Me.ThemeStore?.theme || "dark"
            }), this.emitChange()
        }
        getEditorOptions() {
            let e = k.get("settings", "editor", "theme");
            return e === "system" && (Me.AccessibilityStore?.useForcedColors ? e = "hc-black" : e = Me.ThemeStore?.theme === "light" ? "vs" : "vs-dark"), {
                theme: e,
                fontSize: k.get("settings", "editor", "fontSize"),
                lineNumbers: k.get("settings", "editor", "lineNumbers"),
                minimap: {
                    enabled: k.get("settings", "editor", "minimap")
                },
                hover: {
                    enabled: k.get("settings", "editor", "hover")
                },
                insertSpaces: k.get("settings", "editor", "insertSpaces"),
                tabSize: Number(k.get("settings", "editor", "tabSize")),
                quickSuggestions: {
                    other: k.get("settings", "editor", "quickSuggestions"),
                    comments: k.get("settings", "editor", "quickSuggestions"),
                    strings: k.get("settings", "editor", "quickSuggestions")
                },
                renderWhitespace: k.get("settings", "editor", "renderWhitespace")
            }
        }
    }
});
            ...
            try {
                ...
                let r = await new Promise(u => {
                    ...
                    d = () => {
                        ...
                        for (let f = 0; f < bc.length; f++) c.add(bc[f]);
                        return c
                    },
                    l;
                r.languages.registerCompletionItemProvider("css", {
                    provideCompletionItems: (u, c) => {
                        ...
                        let m = Object.keys(_).length;
                        m !== s && (l = d(), s = m);
                        let h = new Set(l);
                        for (let y of document.all ?? document.querySelectorAll("*"))
                            if (y instanceof Element) {
                                let I = y.classList.value.split(" ");
                                for (let R = 0; R < I.length; R++) h.add(I[R])
                            } h.delete("");
                        let g = r.Range.fromPositions(c);
                        return {
                            suggestions: Array.from(h, y => ({
                                label: `.${y}`,
                    ...
                    q.instead("monaco-editor", u.prototype, "readText", (c, [f], m) => f ? m.call(c, f) : Promise.resolve(DiscordNative.clipboard.read()))
                }), o(["vs/editor/browser/controller/textAreaInput"], ({
                    TextAreaWrapper: u
                }) => {
                    q.instead("monaco-editor", u.prototype, "setSelectionRange", (c, f, m) => {
                        let h = c._actual,
                            g = q.instead("monaco-editor", HTMLElement.prototype, "focus", (I, R, E) => {
                                if (I === h) return E.apply(I)
                            }),
                            y = m.apply(c, f);
                        return g(), y
                    })
...
function xc(a) {
    ...
    if (typeof a == "string" || typeof a == "number") o += a;
        ...
        if (Array.isArray(a)) {
            var r = a.length;
            for (e = 0; e < r; e++) a[e] && (t = xc(a[e])) && (o && (o += " "), o += t)
        } else
...
function Pb() {
    for (var a, e, t = 0, o = "", r = arguments.length; t < r; t++)(a = arguments[t]) && (e = xc(a)) && (o && (o += " "), o += e);
    return o
}
var O, xe = v(() => {
    O = Pb
...
var fe, Ie, xt = v(() => {
    "use strict";
    A();
    fe = Symbol("betterdiscord.none"), Ie = gl({
        value: fe,
        disabled: !1
    })
});
...
function Yt({
    ...
    let [n, s] = Nb(e), {
        value: d,
        disabled: l
    } = Sn(Ie), u = d !== fe, c = u ? d : r ? n : e, f = u ? l : t, m = Fb(() => {
        o?.(!c), s(!c)
...
function Zb(a, e, t) {
    var o = Mc(a),
        r = o.length;
    if (Mc(e).length !== r) return !1;
    for (; r-- > 0;)
        if (!Nc(a, e, t, o[r])) return !1;
    return !0
}
...
function xr(a, e, t) {
    var o = Ec(a),
        r = o.length;
    if (Ec(e).length !== r) return !1;
    for (var n, s, d; r-- > 0;)
        if (n = o[r], !Nc(a, e, t, n) || (s = Tc(a, n), d = Tc(e, n), (s || d) && (!s || !d || s.configurable !== d.configurable || s.enumerable !== d.enumerable || s.writable !== d.writable))) return !1;
    return !0
}

function Xb(a, e) {
    return Oa(a.valueOf(), e.valueOf())
}
...
function Nc(a, e, t, o) {
    return (o === Hb || o === Wb || o === qb) && (a.$$typeof || e.$$typeof) ? !0 : jb(e, o) && t.equals(a[o], e[o], o, o, a, e, t)
}
...
function py(a) {
    ...
    return function(g, y, I) {
        if (g === y) return !0;
        if (g == null || y == null) return !1;
        var R = typeof g;
        if (R !== typeof y) return !1;
        if (R !== "object") return R === "number" ? s(g, y, I) : R === "function" ? r(g, y, I) : !1;
        var E = g.constructor;
        if (E !== y.constructor) return !1;
        if (E === Object) return d(g, y, I);
        if (cy(g)) return e(g, y, I);
        if (zc != null && zc(g)) return f(g, y, I);
        if (E === Date) return t(g, y, I);
        if (E === RegExp) return u(g, y, I);
        if (E === Map) return n(g, y, I);
        if (E === Set) return c(g, y, I);
        var H = fy(g);
        return H === ay ? t(g, y, I) : H === sy ? u(g, y, I) : H === ry ? n(g, y, I) : H === dy ? c(g, y, I) : H === iy ? typeof g.then != "function" && typeof y.then != "function" && d(g, y, I) : H === uy ? m(g, y, I) : H === oy ? o(g, y, I) : H === ey ? d(g, y, I) : H === ty || H === ny || H === ly ? l(g, y, I) : !1
    }
}
...
function my(a) {
    var e = a.circular,
        ...
        o = a.strict,
        r = {
            areArraysEqual: o ? xr : _b,
            areDatesEqual: Vb,
            areErrorsEqual: Gb,
            areFunctionsEqual: Kb,
            areMapsEqual: o ? Ac(Dc, xr) : Dc,
            areNumbersEqual: $b,
            areObjectsEqual: o ? xr : Zb,
            arePrimitiveWrappersEqual: Xb,
            areRegExpsEqual: Jb,
            areSetsEqual: o ? Ac(Pc, xr) : Pc,
            areTypedArraysEqual: o ? xr : Yb,
            areUrlsEqual: Qb
        };
    if (t && (r = Bc({}, r, t(r))), e) {
...
var Ob, Rb, Ub, jb, qb, Wb, Hb, Tc, Mc, $b, ey, ty, ay, oy, ry, ny, iy, sy, dy, ly, uy, cy, zc, Bc, fy, b1, y1, x1, v1, Fc, w1, k1, C1, Oc = v(() => {
    Ob = Object.getOwnPropertyNames, Rb = Object.getOwnPropertySymbols, Ub = Object.prototype.hasOwnProperty;
    jb = Object.hasOwn || function(a, e) {
        return Ub.call(a, e)
    };
    qb = "__v", Wb = "__o", Hb = "_owner", Tc = Object.getOwnPropertyDescriptor, Mc = Object.keys;
    $b = Oa;
    ey = "[object Arguments]", ty = "[object Boolean]", ay = "[object Date]", oy = "[object Error]", ry = "[object Map]", ny = "[object Number]", iy = "[object Object]", sy = "[object RegExp]", dy = "[object Set]", ly = "[object String]", uy = "[object URL]", cy = Array.isArray, zc = typeof ArrayBuffer == "function" && ArrayBuffer.isView ? ArrayBuffer.isView : null, Bc = Object.assign, fy = Object.prototype.toString.call.bind(Object.prototype.toString);
    b1 = ga(), y1 = ga({
        strict: !0
    }), x1 = ga({
        circular: !0
...
function he(a, e, t, o = (r, n) => r === n) {
    let [, r] = vr(), n = pa(void 0), s = pa(void 0), d = pa(null);
    d.current = o === !0 ? Fc : o, s.current === void 0 && (s.current = e, n.current = e());
    let l = pa(void 0);
    if (t && l.current) {
...
function ky(a) {
    ...
    }, i.createElement(D, null, a.label), i.createElement(Yt, {
        onChange: a.onChange,
        value: a.checked
    }))
}
...
function Uc(a, e) {
    return e.type == "boolean" ? ky(e) : wy(e, a)
}
var vo, Dn, Rc, by, yy, xy, vy, Pn, qi = v(() => {
    "use strict";
    A();
    Z();
    me();
    ...
    Pn = by(function({
        ...
        let d = pa(null),
            l = pa(null),
            u = yy(() => {
                let $ = t.toLowerCase().replace(/ /g, "_");
                return vy.includes($) ? $ : "css"
            }, [t]),
            [c, f] = vo(() => br.getEditorOptions().theme),
            [m, h] = vo(),
            [, g] = vo([]),
            [y, I] = vo([0, 0, 0]),
            [R, E] = vo([0, 0, []]),
            {
                ...
                insertSpaces: k.get("settings", "editor", "insertSpaces"),
                tabSize: k.get("settings", "editor", "tabSize")
            })),
            [T, ae] = vo(!1),
            z = Dn(() => ae($ => !$), []),
            ue = Dn(() => {
        ...
        }), [m, Ce]), Rc(() => (g($ => [...$, m?.onDidChangeModelContent(ue)]), () => {
            g($ => {
                for (let Re of $) Re?.dispose();
                return []
            })
        }), [m, ue]), In(() => {
            let $ = d.current || document.getElementById(o);
            if (!$) return;
            let Re = () => {
                let Ee = document.createElement("textarea");
                Ee.className = "bd-fallback-editor", Ee.value = e, h({
                    dispose: () => Ee.remove(),
                    getValue: () => Ee.value,
                    setValue: da => Ee.value = da,
                    layout: () => {},
                    onDidChangeModelContent: da => (Ee.onchange = da, Ee.oninput = da, {
                        dispose() {}
                    }),
                    isFallback: !0
                }), $.appendChild(Ee)
            ...
            let se = !1,
                le, Ue = () => {
                    let Ee = () => ({
                        ...
                        da = window.monaco.editor.onDidChangeMarkers(([Xe]) => {
                            if (Ct.getModel().uri !== Xe) return;
                            let to = window.monaco.editor.getModelMarkers({
                                    resource: Xe
                                }),
                                ao = 0,
                                an = 0;
                            for (let St of to) St.severity === 4 ? an++ : St.severity === 8 && ao++;
                            E([ao, an, to])
                        }),
                        Ct = window.monaco.editor.create($, Ee());
                    h(Ct), Ct.onDidChangeCursorSelection(() => {
                        let Xe = Ct.getPosition(),
                            to = Ct.getSelection(),
                            ao = Ct.getModel().getValueInRange(to);
                        I([Xe.lineNumber, Xe.column, ao.length])
                    });

                    function Fo() {
                        let Xe = getComputedStyle(Ct.getDomNode()),
                            to = Xe.getPropertyValue("--vscode-editor-background"),
                            ao = Xe.getPropertyValue("--vscode-foreground"),
                            an = Xe.getPropertyValue("--vscode-tree-tableColumnsBorder"),
                            St = l.current?.parentElement?.parentElement;
                        (!St || !St.classList.contains("floating-window")) && (St = l.current), St && (St.style.setProperty("--bd-editor-background", to), St.style.setProperty("--bd-editor-foreground", ao), St.style.setProperty("--bd-editor-divider", an))
                    }
                    let tn = br.addChangeListener(() => {
                        Ct.updateOptions(Ee()), f(br.getEditorOptions().theme), Fo()
                    });
                    Fo(), le = () => {
                        Ct.dispose(), tn(), da.dispose()
                    }, se && le()
                };
        ...
        }, [o, u, e]), Rc(() => (window.addEventListener("resize", Ce), () => {
            window.removeEventListener("resize", Ce)
        }), [Ce]), m && m.layout && m.layout();
        let K = Dn(() => {
                m.focus(), m.trigger("keyboard", "editor.action.gotoLine", "")
            }, [m]),
            de = r.filter($ => $.side != "right").map(Uc.bind(null, () => m?.getValue())),
            Pe = r.filter($ => $.side == "right").map(Uc.bind(null, () => m?.getValue()));
        return i.createElement("div", {
            id: "bd-editor-panel",
            className: c,
            ref: l
        ...
        }, "No Problems have been detected."), R[2].map(($, Re) => i.createElement("div", {
            key: Re,
            className: `bd-editor-problem bd-editor-severity-${$.severity}`
        }, $.severity === 8 ? i.createElement(Kt, {
            size: "1em"
        }) : $.severity === 4 ? i.createElement(Qe, {
            size: "1em"
        }) : $.severity === 2 ? i.createElement(je, {
            size: "1em"
        }) : i.createElement(je, {
            size: "1em"
        }), i.createElement("span", null, $.message), i.createElement("span", null, $.source, "(", $.code, ")"), i.createElement("span", null, "[Ln ", $.startLineNumber, ", Col ", $.startColumn, "]"))))), !m?.isFallback && i.createElement("div", {
            ...
            className: "bd-editor-footer-item",
            onClick: K
        }, i.createElement("span", null, "Ln ", y[0]), i.createElement("span", null, ", "), i.createElement("span", null, "Col ", y[1]), !!y[2] && i.createElement("span", null, " (", y[2], " selected)")), i.createElement("div", {
            className: "bd-editor-footer-item"
        }, i.createElement("span", null, H ? "Spaces" : "Tabs"), i.createElement("span", null, ": "), i.createElement("span", null, L)), i.createElement("div", {
            className: "bd-editor-footer-item"
        }, i.createElement(ha, {
            size: "1em"
...
var Cy, Wi, Sy, Ly, Iy, jc, qc = v(() => {
    ...
    ({
        ...
        return i.createElement(Pn, {
            ...
            id: n,
            controls: [{
                label: i.createElement(za, {
                    size: "18px"
                }),
                tooltip: p("CustomCSS.save"),
                onClick: m
            }, {
                label: i.createElement(dt, {
                    size: "18px"
                }),
...
function Ae({
    ...
    let n = e == 0 || e == 1,
        ...
        l = C.ReactSpring.useSpring({
            ...
            config: {
                duration: n ? 300 : 100,
                easing: n ? Hi.Easing.inOut(Hi.Easing.back()) : Hi.Easing.quad,
                clamp: !0
            }
        });
...
var Hi, Hc, _c, Ey, ja = v(() => {
    ...
    Hi = te(["Easing"], {
        ...
        CUSTOM: ""
    }), Ey = ne(a => a?.render?.toString().includes("impressionProperties") && a?.render?.toString().includes(".Provider"), {
        searchExports: !0,
        firstId: 305866,
...
var ea, _i = v(() => {
    "use strict";
    At();
    ea = new class extends ye {
        pluginErrors = [];
        themeErrors = [];
        addPluginError(e) {
            this.pluginErrors.push(e), this.emitChange()
        }
        addThemeError(e) {
            this.themeErrors.push(e), this.emitChange()
        }
        clearErrors() {
            this.pluginErrors = [], this.themeErrors = [], this.emitChange()
        }
    }
});
...
function My({
    ...
    let [t, o] = Gc(!1), r = Kc(() => o(!t), [t]);

    function n() {
        let s = (C.SimpleMarkdownWrapper || C.SimpleMarkdown)?.defaultRules,
            d = a?.error?.stack ?? a.stack;
        return !t || !d ? null : i.createElement("div", {
            className: "bd-addon-error-body"
        }, i.createElement(wo, null), i.createElement("div", {
    ...
    }, a.type == "plugin" ? i.createElement(Xt, null) : i.createElement($t, null)), i.createElement("div", {
...
function Vi({
    ...
    let t = he(ea, () => [...ea.pluginErrors]),
        o = he(ea, () => [...ea.themeErrors]),
        r = Ty(() => [t.length && Vc("plugins", t), o.length && Vc("themes", o)].filter(u => u), [t, o]),
        [n, s] = Gc(r[0]?.id),
        d = Kc(u => s(u), []),
        l = r.find(u => u.id === n);
    ...
    }, u.name))))), i.createElement(Ua, {
        className: "bd-error-modal-content"
    }, i.createElement("div", {
        className: "bd-addon-errors"
    }, l?.errors.map((u, c) => i.createElement(My, {
        index: c,
        err: u
    })))), i.createElement(Qt, {
...
var pe, Dy, ba = v(() => {
    ...
    }, Dy = pe.prototype.render;
    Object.defineProperty(pe.prototype, "render", {
        enumerable: !1,
        configurable: !1,
        set: function() {
...
function Fn({
    ...
    return zy(() => {
        ...
        t?.()
    }, [t]), i.createElement(Ae, {
        transitionState: a,
        size: r,
        className: o
    }, i.createElement(Ra, null, i.createElement(D, {
        tag: "h1",
        size: D.Sizes.SIZE_20,
        color: D.Colors.HEADER_PRIMARY,
        strong: !0
    }, n)), i.createElement(Ua, null, s), i.createElement(Qt, null, f && i.createElement(w, {
        type: "submit",
        buttonRef: m,
        color: d ? w.Colors.RED : w.Colors.BRAND,
        onClick: () => {
            u?.(), e?.()
        }
    }, f), c && i.createElement(w, {
        type: "button",
        look: w.Looks.LINK,
...
var Oe, qa = v(() => {
    ...
    Oe = class {
        ...
        static _initialize() {
            if (C.SimpleMarkdownWrapper) {
                this._parse = r => C.SimpleMarkdownWrapper.parse(r, !0, {
                    allowLinks: !0
                }), this._renderer = r => r;
                return
            }
            if (!C.SimpleMarkdown) {
                this._parse = r => r, this._renderer = r => r;
                return
            }
            let e = C.SimpleMarkdown,
...
function Wy({
    ...
    return a.toLowerCase().includes("youtube.com") ? i.createElement(qy, {
        src: a
...
function $i({
    ...
    let c = Ki(() => i.createElement(Ra, {
        ...
        }, o)), i.createElement(Gi, {
            onClick: r
        })), [t, o, r]),
        f = Ki(() => i.createElement(Qt, {
            justify: j.Justify.BETWEEN,
            direction: j.Direction.HORIZONTAL
        }, i.createElement(j.Child, {
            grow: "1",
            shrink: "1"
        }, e || Ry), !e && i.createElement(j.Child, {
            grow: "0",
            shrink: "0"
        }, Uy, jy)), [e]),
        m = Ki(() => {
            let h = [];
            n ? h.push(i.createElement(Wy, {
                src: n,
                poster: s
            })) : d && h.push(i.createElement("img", {
                src: d,
                className: "bd-changelog-poster"
            })), l && h.push(i.createElement("p", null, Oe.parseToReact(l)));
            for (let g = 0; g < (u?.length ?? 0); g++) {
                let y = u[g],
                    I = "bd-changelog-" + y.type,
                    R = g == 0 ? " bd-changelog-first" : "";
                h.push(i.createElement("h1", {
                    className: `bd-changelog-title ${I}${R}`
                }, y.title)), y.blurb && h.push(i.createElement("p", null, Oe.parseToReact(y.blurb)));
                let E = i.createElement("ul", null, y.items.map(H => i.createElement("li", null, Oe.parseToReact(H))));
                h.push(E)
            }
            return h
        }, [l, n, d, s, u]);
    return i.createElement(Ae, {
        ...
        transitionState: a,
        size: Ae.Sizes.MEDIUM,
        style: Ae.Styles.STANDARD
    }, c, i.createElement(Ua, null, m), (e || t === "BetterDiscord") && f)
}
var Ki, Jc, Ny, Fy, Oy, Ry, Uy, jy, Yc = v(() => {
    "use strict";
    A();
    Z();
    G();
    ...
    ({
        useMemo: Ki
    } = i), Jc = te(["anchorUnderlineOnHover"], {
        firstId: 820162,
        ...
        a.preventDefault(), a.stopPropagation(), B.showGuildJoinModal("pwXhuRkmgy"), C.Dispatcher?.dispatch({
            type: "LAYER_POP"
        })
    }, Fy = async a => {
        a.detail === 3 && (a.preventDefault(), a.stopPropagation(), await J.allowPreloadOverride.toggle(), J.relaunch())
    }, Oy = i.createElement("a", {
        className: `${Jc.anchor} ${Jc.anchorUnderlineOnHover}`,
        onClick: Ny
    }, "Join our Discord Server."), Ry = i.createElement(D, null, i.createElement("span", {
        onClick: Fy
    }, "Need support?"), " ", Oy), Uy = i.createElement(C.Tooltip, {
        color: "primary",
        position: "top",
...
function Zi({
    ...
    })((r, n) => n ? i.createElement(Qc.animated.div, {
...
function Ji() {
    ...
    return Vy(() => (F.on("open-modal", t), () => {
        F.off("open-modal", t)
    }), [t]), i.createElement(Gy, {
        component: Hy
    }, i.createElement(Zi, {
        isVisible: !!a.length,
        onClick: () => o(a[a.length - 1].modalKey)
    }), !!a.length && i.createElement(Xi, {
        key: a[a.length - 1].modalKey,
        ...a[a.length - 1],
        onClose: () => o(a[a.length - 1].modalKey)
    }))
}
var Hy, _y, tf, Vy, af, of, Gy, Xi, rf, nf, sf = v(() => {
    "use strict";
    A();
    Ne();
    ef();
    ...
    ({
        ...
        useCallback: tf,
        useEffect: Vy
    } = i), [af, of] = Dt(a => a?.defaultProps?.transitionAppear), Gy = af && of ? af[of] : function() {}, Xi = class extends i.Component {
        constructor(e) {
            super(e), this.state = {
...
var Ky, B, ke = v(() => {
    ...
    Ky = [], B = class {
        static get shouldShowAddonErrors() {
            return k.get("settings", "addons", "addonErrors")
        }
        ...
        static get ModalActions() {
            return this._ModalActions ??= ca("?.stackNextByDefault", {
                openModal: N.byStrings("?.stackNextByDefault"),
                closeModal: N.byStrings(".setState", ".getState()["),
                closeAllModals: N.byStrings(".getState();for")
            }, {
                firstId: 192308,
        ...
        static showConfirmationModal(e, t, o = {}) {
            ...
            Array.isArray(t) || (t = [t]), t = t.map(g => typeof g == "string" ? Oe.parseToReact(g) : g);
            let h = this.openModal(g => i.createElement(pe, {
                onError: () => {
                    setTimeout(() => {
        ...
        static addonErrorsOpen = !1;
        static showAddonError(e) {
            this.shouldShowAddonErrors && (e.type === "theme" ? ea.addThemeError(e) : ea.addPluginError(e), !this.addonErrorsOpen && (this.addonErrorsOpen = !0, this.ModalActions.openModal(t => i.createElement(pe, {
                id: "showAddonErrors",
                name: "Modals"
            }, i.createElement(Vi, {
                ...t
                ...
                onCloseCallback: () => {
                    this.addonErrorsOpen = !1, ea.clearErrors()
                }
            })))
        }
        static showChangelogModal(e = {}) {
            return this.openModal(o => i.createElement(pe, {
                id: "showChangelogModal",
                name: "Modals"
            }, i.createElement($i, Object.assign(e, o))))
        }
        static async showGuildJoinModal(e) {
            ...
            let r = q.instead("BetterDiscord~showGuildJoinModal", C.RemoteModule, "minimize", () => {}),
                n = q.instead("BetterDiscord~showGuildJoinModal", C.RemoteModule, "focus", () => {});
            try {
        ...
        static showAddonSettingsModal(e, t) {
            ...
            return this.openModal(n => i.createElement(pe, {
                id: "showAddonSettingsModal",
                name: "Modals"
            }, i.createElement(Fn, Object.assign(r, n), o)))
        }
        static hasInitialized = !1;
        static makeStack() {
            let e = P.parseHTML('<div id="bd-modal-container">');
            P.bdBody.append(e), ht.createRoot(e).render([i.createElement(pe, {
                id: "makeStack",
                name: "Modals",
                hideError: !0
            }, i.createElement(Ji))]), this.hasInitialized = !0
        }
        static openModal(e, t = {}) {
            return typeof this.ModalActions.openModal == "function" ? this.ModalActions.openModal(e) : (this.hasInitialized || this.makeStack(), t.modalKey = nf(t.modalKey), F.emit("open-modal", e, t), t.modalKey)
        }
    };
    B.makeStack()
});
...
function Xy(a) {
    return new Promise(e => {
        B.showConfirmationModal(p("Modals.confirmAction"), a, {
            danger: !0,
...
function Yi({
    ...
    let T = On({
        ...
        max: {
            get x() {
                return L.current.x === -1 ? Co.width : L.current.x
            },
            get y() {
                return L.current.y === -1 ? Co.height : L.current.y
            }
        },
        min: {
            x: c,
    ...
    T.current.min.x = c, T.current.min.y = f;
    let ae = On(null),
        z = On(null),
        ue = ko(() => {
            T.current.size.width = z.current.offsetWidth, T.current.size.height = z.current.offsetHeight
        }, [z]),
        Ce = ko(se => {
            if (!T.current.isDragging) return;
            let le = se.clientY - T.current.offset.y;
            le <= T.current.min.y && (le = T.current.min.y), le + T.current.size.height >= T.current.max.y && (le = T.current.max.y - T.current.size.height);
            let Ue = se.clientX - T.current.offset.x;
            Ue <= T.current.min.x && (Ue = T.current.min.x), Ue + T.current.size.width >= T.current.max.x && (Ue = T.current.max.x - T.current.size.width), T.current.position.x = Ue, T.current.position.y = le, z.current.style.left = `${Ue}px`, z.current.style.top = `${le}px`
        }, []),
        K = ko(se => {
            let le = z.current;
            T.current.offset.x = se.clientX - le.offsetLeft, T.current.offset.y = se.clientY - le.offsetTop, T.current.isDragging = !0
        }, [z]),
        de = ko(() => {
            T.current.isDragging = !1;
            let se = z.current.offsetWidth,
                le = z.current.offsetHeight;
            if (se != T.current.size.width || le != T.current.size.height) {
                g && g();
                let Ue = parseInt(z.current.style.left),
                    Ee = parseInt(z.current.style.top);
                Ue + se >= T.current.max.x && (z.current.style.width = T.current.max.x - Ue + "px"), Ee + le >= T.current.max.y && (z.current.style.height = T.current.max.y - Ee + "px")
            }
            T.current.size.width = se, T.current.size.height = le, z.current.style.left = `${T.current.position.x}px`, z.current.style.top = `${T.current.position.y}px`
        }, [z, g]);
    Zy(() => {
        let se = z.current,
            le = ae.current;
        return se.addEventListener("mousedown", ue, !1), le.addEventListener("mousedown", K, !1), document.addEventListener("mouseup", de, !1), document.addEventListener("mousemove", Ce, !0), () => {
            document.removeEventListener("mouseup", de, !1), document.removeEventListener("mousemove", Ce, !0), se.removeEventListener("mousedown", ue, !1), le.removeEventListener("mousedown", K, !1)
        }
    }, [ae, z, K, de, Ce, ue]);
    let Pe = ko(() => {
            z.current.style.width = "100%", z.current.style.height = "100%", g && g();
            let se = z.current.offsetWidth,
                le = z.current.offsetHeight,
                Ue = parseInt(z.current.style.left),
                Ee = parseInt(z.current.style.top),
                da = Ue + se;
            Ee + le > T.current.max.y && (z.current.style.top = T.current.max.y - le + "px"), da > T.current.max.x && (z.current.style.left = T.current.max.x - se + "px");
            let Fo = parseInt(z.current.style.left),
                tn = parseInt(z.current.style.top);
            if (tn < T.current.min.y) {
                let Xe = T.current.min.y - tn;
                z.current.style.top = T.current.min.y + "px", z.current.style.height = le - Xe + "px"
            }
            if (Fo < T.current.min.x) {
                let Xe = T.current.min.x - Fo;
                z.current.style.left = T.current.min.x + "px", z.current.style.height = se - Xe + "px"
            }
        }, [z, g]),
        $ = ko(async () => {
            let se = !0;
            (typeof I == "function" ? I() : I) && (H(!0), se = await Xy(R), H(!1)), y && se && y()
        }, [R, y, I]),
        Re = `floating-window${r?` ${r}`:""}${t?" resizable":""}${E?" modal-open":""}`;
    return In(() => {
        z.current.style.height = `${u}px`, z.current.style.width = `${l}px`, T.current.position.x = n ? Co.width / 2 - l / 2 : d, T.current.position.y = n ? Co.height / 2 - u / 2 : s, z.current.style.left = `${T.current.position.x}px`, z.current.style.top = `${T.current.position.y}px`
...
function Qi() {
    ...
    return Yy(() => (F.on("open-window", t), () => void F.off("open-window", t)), [t]), a.map(r => i.createElement(Yi, {
        ...r,
        onClose: () => o(r.id),
        key: r.id
    }, r.children))
...
var cf, ff, ta, Rn = v(() => {
    ...
    uf();
    ce();
    cf = ll("AppLayerProvider"), ff = !1, ta = class {
        static initialize() {
            let e = i.createElement(Qi, null),
                t = cf ? i.createElement(cf().props.layerContext.Provider, {
                    value: [document.querySelector("#app-mount > .layerContainer-2v_Sit")]
                }, e) : e,
                o = P.parseHTML('<div id="floating-windows-layer">');
            P.bdBody.append(o), ht.createRoot(o).render(t), ff = !0
        }
        static open(e) {
            return ff || this.initialize(), F.emit("open-window", e)
        }
    }
});
var Rt, Ge, Na, gr = v(() => {
    "use strict";
    Rt = ze(require("path"), 1), Ge = ze(require("fs"), 1);
    ee();
    Ri();
    me();
    Ne();
    ...
    Na = class extends ye {
        ...
        addonInfo = [];
        trigger(e, ...t) {
            return super.emitChange(), F.emit(`${this.prefix}-${e}`, ...t)
        }
        timeCache = {};
        state = {};
        windows = new Set;
        ...
        initialize() {
            this.loadState(), this.watchAddons(), this.readAllAddons(), k.registerAddonPanel(this)
        }
        finishInit() {
            this.addonInfo = [], this.hasInitialized = !0, this.initialAddonsLoaded !== 0 && W.show(p("Addons.manyEnabled", {
        ...
        showAddonError(e, t, o) {
            return B.showAddonError(new xo(e.name || e.filename, e.filename, t, o, this.prefix)), null
        }
        watchAddons() {
            b.log(this.name, `Starting to watch ${this.prefix} addons.`), Ge.default.watch(this.addonFolder, {
                persistent: !1
            }, async (e, t) => {
                if (!e || !t) return;
                let o = Rt.default.resolve(this.addonFolder, t);
                if (!t.endsWith(this.extension)) {
                    let r = t.match(this.duplicatePattern);
                    if (!r) return;
                    let n = r[0],
                        d = t.replace(n, "") + this.extension,
                        l = Rt.default.resolve(this.addonFolder, d);
                    if (Ge.default.existsSync(l)) {
                        b.warn(this.name, `Duplicate files found: ${t} and ${d}`);
                        return
                    }
                    try {
                        Ge.default.renameSync(o, l), t = d, o = l
                    } catch (u) {
                        b.err(this.name, `Could not rename file: ${t} ${d}`, u);
                        return
                    }
                }
                await new Promise(r => setTimeout(r, 100));
                try {
                    let r = Ge.default.statSync(o);
                    if (!r?.isFile() || typeof r.mtimeMs != "number" || this.timeCache[t] == r.mtimeMs) return;
                    this.timeCache[t] = r.mtimeMs, e == "rename" ? (this.unloadAddon(t), this.readAddon(t, !0)) : e == "change" && this.reloadAddon(t)
                } catch (r) {
                    if (r.code !== "ENOENT" && !r?.message.startsWith("ENOENT")) return;
                    delete this.timeCache[t], this.unloadAddon(t)
                }
            })
        }
        readAllAddons() {
            let e = Ge.default.readdirSync(this.addonFolder);
            for (let t of e) {
                let o = Rt.default.resolve(this.addonFolder, t),
                    r = Ge.default.statSync(o);
                if (!r || !r.isFile()) continue;
                if (!t.endsWith(this.extension)) {
                    let s = t.match(this.duplicatePattern);
                    if (!s) continue;
                    let l = t.replace(s[0], "") + this.extension,
                        u = Rt.default.resolve(this.addonFolder, l);
                    if (Ge.default.existsSync(u)) {
                        b.warn("AddonManager", `Duplicate files found: ${t} and ${l}`);
                        continue
                    }
                    try {
                        Ge.default.renameSync(o, u), t = l
                    } catch (c) {
                        b.err("AddonManager", `Could not rename file: ${t} ${l}`, c)
                    }
                }
                this.timeCache[t] = r.mtimeMs;
                let n = this.readAddon(t);
                n && this.addonInfo.push(n)
            }
            this.saveState()
        }
        readAddon(e, t) {
            let o = Rt.default.resolve(this.addonFolder, e),
                r = Ge.default.readFileSync(o, "utf8");
            r.charCodeAt(0) === 65279 && (r = r.slice(1));
            let n = r.indexOf(`
`);
            if (n === -1 && (n = r.length), !r.slice(0, n).includes("/**")) return B.showAddonError(new xo(e, e, p("Addons.metaNotFound"), {
                message: "",
                stack: r
            }, this.prefix)), null;
            let l = Ge.default.statSync(o),
                u = fo(r);
            return (!u.author || typeof u.author != "string") && (u.author = p("Addons.unknownAuthor")), (!u.version || typeof u.version != "string") && (u.version = "???"), (!u.description || typeof u.description != "string") && (u.description = p("Addons.noDescription")), u.runAt !== "idle" && (u.runAt = "connection"), u.id = u.name || e, u.slug = e.replace(this.extension, "").replace(/ /g, "-"), u.filename = e, u.added = l.atimeMs, u.modified = l.mtimeMs, u.size = l.size, u.fileContent = r, t && this.loadAddon(u), u
        }
        loadAddon(e) {
            let t = this.initAddon(e);
            if (!t) {
                this.state[e.id] = !1, e.partial = !0, this.addonList.push(e), this.trigger("loaded", e);
                return
            }
            this.addonList.push(t), this.trigger("loaded", t), this.hasInitialized && W.success(p("Addons.wasLoaded", {
                name: e.name,
                version: e.version
            })), this.state[t.id] && this.startAddon(t)
        }
        unloadAddon(e, t = !1) {
            let o = this.resolveAddon(e);
            return o ? (this.state[o.id] && (t ? this.stopAddon(o) : this.disableAddon(o)), this.addonList.splice(this.addonList.indexOf(o), 1), this.trigger("unloaded", o), W.success(p("Addons.wasUnloaded", {
                name: o.name
            })), !0) : !1
        }
        reloadAddon(e) {
            let t = this.resolveAddon(e);
            return !t || !this.unloadAddon(t, !0) ? !1 : (this.readAddon(t.filename, !0), !0)
        }
        isLoaded(e) {
            return !!this.resolveAddon(e)
        }
        isEnabled(e) {
            let t = this.resolveAddon(e);
        ...
        enableAllAddons() {
            for (let e of this.addonList) this.enableAddon(e);
            this.trigger("batch")
        }
        disableAddon(e) {
            let t = this.resolveAddon(e);
        ...
        disableAllAddons() {
            for (let e of this.addonList) this.disableAddon(e);
            this.trigger("batch")
        }
        toggleAddon(e) {
        ...
        deleteAddon(e) {
            let t = this.resolveAddon(e);
            if (t) return Ge.default.unlinkSync(Rt.default.resolve(this.addonFolder, t.filename))
        }
        saveAddon(e, t) {
            let o = this.resolveAddon(e);
            if (o) return Ge.default.writeFileSync(Rt.default.resolve(this.addonFolder, o.filename), t)
        }
        editAddon(e, t) {
            let o = this.resolveAddon(e);
            if (!o) return;
            let r = Rt.default.resolve(this.addonFolder, o.filename);
            return typeof t > "u" && (t = k.get("settings", "addons", "editAction")), t === "system" ? J.openPath(`${r}`) : t === "external" ? M.editor.open(this.prefix, o.filename) : this.openDetached(o)
        }
        openDetached(e) {
            let t = Rt.default.resolve(this.addonFolder, e.filename),
                o = Ge.default.readFileSync(t).toString();
            if (this.windows.has(t)) return;
            this.windows.add(t);
            let r = i.createRef(),
                n = i.createElement(jc, {
        ...
        resolveAddon(e) {
            return typeof e == "string" ? this.addonList.find(t => t.id === e || t.filename === e) : e
        }
    }
});
var gc = {};
...
if (module.exports.default) {
    module.exports = module.exports.default;
}`, ie = new class extends Na {
        name = "PluginManager";
        extension = ".plugin.js";
        duplicatePattern = /\.plugin\s?\([0-9]+\)\.js/;
        addonFolder = V.get("pluginsPath");
        prefix = "plugin";
        language = "javascript";
        order = 3;
        observer;
        ...
        loadAddons(e) {
            b.log("PluginManager", `Loading addons at point: ${e}`);
            for (let t of this.addonInfo) t.runAt === e && this.loadAddon(t);
            e === "idle" && this.finishInit()
        }
        runPlugin(e) {
            try {
                let t = {
                    ...
                    o = e;
                return o.fileContent += Qy + `
//# sourceURL=betterdiscord://plugins/${o.filename}`, new Function("require", "module", "exports", "__filename", "__dirname", o.fileContent)(window.require, t, t.exports, t.filename, this.addonFolder), o.exports = t.exports, delete o.fileContent, o
            } catch (t) {
                return this.showAddonError(e, p("Addons.compileError"), {
                    message: t.message,
                    stack: t.stack
                })
            }
        ...
        initAddon(e) {
            ...
            if (!t) return null;
            if (!t.exports || !t.name) return this.showAddonError(t, "Plugin had no exports or @name property", {
                message: "Plugin had no exports or no @name property. @name property is required for all addons.",
                stack: ""
            });
            if (typeof t.exports != "function") return this.showAddonError(t, "Plugin not a valid format.", {
            ...
            delete o.exports;
            try {
                let n = r.prototype ? new r(o) : r(o);
                if (!n.start || !n.stop) return this.showAddonError(t, "Missing start or stop function.", {
                    message: "Plugins must have both a start and stop function.",
                    stack: ""
                });
                if (t.instance = n, t.name = n.getName ? n.getName() : t.name, t.author = n.getAuthor ? n.getAuthor() : t.author, t.description = n.getDescription ? n.getDescription() : t.description, t.version = n.getVersion ? n.getVersion() : t.version, !t.name || !t.author || !t.description || !t.version) return this.showAddonError(t, "Plugin is missing name, author, description, or version", {
                    message: "Plugin must provide name, author, description, and version.",
                    stack: ""
                });
                try {
                    return typeof n.load == "function" && n.load(), t
                } catch (s) {
                    return this.state[t.id] = !1, this.showAddonError(e, p("Addons.methodError", {
                        method: "load()"
                    }), {
                        message: s.message,
                        stack: s.stack
                ...
                return this.showAddonError(e, p("Addons.methodError", {
        ...
        startAddon(e) {
            ...
            if (t) {
                try {
                    ...
                    return this.state[t.id] = !1, this.trigger("disabled", t), W.warning(p("Addons.couldNotStart", {
                        name: t.name,
                        version: t.version
                    })), b.stacktrace(this.name, `${t.name} v${t.version} could not be started.`, o), this.showAddonError(t, p("Addons.methodError", {
                        method: "start()"
                    }), {
                        message: o.message,
                        stack: o.stack
                ...
                this.trigger("started", t.id), this.hasInitialized ? W.success(p("Addons.enabled", {
                    name: t.name,
                    version: t.version
                })) : this.initialAddonsLoaded++
            }
        ...
        stopAddon(e) {
            ...
            if (t) {
                try {
                    ...
                    return this.state[t.id] = !1, W.warning(p("Addons.couldNotStop", {
                        name: t.name,
                        version: t.version
                    })), b.stacktrace(this.name, `${t.name} v${t.version} could not be stopped.`, o), this.showAddonError(t, p("Addons.methodError", {
                        method: "stop()"
                    }), {
                        message: o.message,
                        stack: o.stack
                ...
                this.trigger("stopped", t.id), W.error(p("Addons.disabled", {
                    name: t.name,
                    version: t.version
                }))
            }
        ...
        setupFunctions() {
            F.on("navigate", this.onSwitch), this.observer.observe(document, {
                childList: !0,
                subtree: !0
            })
        }
...
var ft = M.path,
    ...
    ka = class a {
        static resolveMainFile(e, t) {
            let o = ft.extname(t) ? ft.dirname(t) : t,
                r = M.filesystem.readDirectory(o);
            if (!Array.isArray(r)) return null;
            for (let n of r) {
                let s = ft.extname(n);
                if (n === "package.json") {
                    let d = require(ft.resolve(o, n));
                    if (!Reflect.has(d, "main")) continue;
                    return ft.resolve(o, d.main)
                }
                if (s.slice(0, -s.length) == "index" && Ro[s]) return e
            }
        }
        static getExtension(e) {
            return ft.extname(e) || Reflect.ownKeys(Ro).find(t => M.filesystem.exists(e + t))
        }
        static getFilePath(e, t) {
            if (ft.isAbsolute(t) || (t = ft.resolve(e, t)), !ft.extname(t)) {
                let r = Reflect.ownKeys(Ro).find(n => M.filesystem.exists(t + n));
                r && (t = t + r)
            }
            return Be.realpathSync(t)
        }
        static _load(e, t, o) {
            let r = e;
            ft.isAbsolute(e) || (e = ft.resolve(t, e));
            ...
            let u = window.require.cache[e] = new a(n, ah, o(e));
        ...
        _compile(e) {
            di(e, ["require", "module", "exports", "__filename", "__dirname", "global"], this.filename)(this.require, this, this.exports, this.filename, this.path, window)
        }
    },
    ah = new ka(".", null);
Oo();
ee();
_e();
var sd = ["get", "put", "post", "delete", "head"],
    id = {
        del: "delete"
    };
...
function li(a, e) {
    return (t, o, r) => {
        try {
            let n;
            if (a.headers)
                if (oh(a.headers)) n = a.headers.find(([s]) => s.toLowerCase() === "content-type")?.[1];
                else {
...
function la(...a) {
    ...
    return !ld(e) || !ud(o) ? null : "method" in t && sd.indexOf(t.method.toLowerCase()) >= 0 ? M.https[t.method](e, t, li(t, o)) : M.https.request(e, t, li(t, o))
}
Object.assign(la, Object.fromEntries(sd.concat(Object.keys(id)).map(a => [a, function(...e) {
    let {
        url: t,
        options: o = {},
        callback: r
    } = dd.apply(this, e);
    return !ld(t) || !ud(r) ? null : M.https[id[a] || a](t, o, li(o, r))
}])));
_e();
...
Object.defineProperty(window, "Buffer", {
    get() {
        return b.warn("Deprecated", "Usage of the Buffer global is deprecated. Consider using web standards such as Uint8Array and TextDecoder/TextEncoder."), vi.Buffer
    },
    configurable: !0,
    enumerable: !1
});
...
var Nd = new Map([
    ...
    wi = Object.assign({}, Be);
wi.writeFileSync = (a, e, t) => Be.writeFileSync(a, e, Object.assign({}, t, {
    originalFs: !0
}));
wi.writeFile = (a, e, t) => Be.writeFile(a, e, Object.assign({}, t, {
    originalFs: !0
}));
var Fd = function(a) {
        return e => {
            if (!(typeof e == "string" && e.startsWith("./"))) switch (Nd.has(e) && b.warn("Remote~Require", `The "${e}" module is marked as deprecated. ${Nd.get(e)}`), e) {
                case "request":
                    return la;
                case "https":
                    return cd;
                ...
                case "crypto":
                    return Bd;
                default:
                    return ka._load(e, a, Fd)
            }
        }
    },
    ln = window.require = Fd(".");
ln.cache = {};
ln.resolve = a => {
    for (let e of Object.keys(ln.cache))
        if (e.startsWith(a)) return ln.cache[e]
};
...
/* =============== */
/*  END V2 LOADER  */`,
    un = document.createElement("style");
un.textContent = Oh;
var so = document.createElement("div");
so.id = "bd-loading-icon";
so.className = "bd-loaderv2";
so.title = "BetterDiscord is loading...";
var lo = class {
    static show() {
        document.body.appendChild(un), document.body.appendChild(so)
    }
    static hide() {
        un && un.remove(), so && so.remove()
    }
};
ee();
qe();
...
var cn = {
    title: "BetterDiscord",
    subtitle: `v${V.get("version")}`,
    blurb: "Hot Fixes.",
    changes: [{
        type: "improved",
        title: "Performance Improvements",
        items: ["Improved start up times"]
    }, {
        title: "Fixes",
        type: "fixed",
        items: ["Theme Attributes is fixed", "BetterDiscords version now shows"]
    }]
};
var oi = {};
rn(oi, {
    ...
    ReactDevTools: () => mp,
    Recovery: () => cp,
    RemoveMinimumSize: () => vp,
    StopDevToolsWarning: () => gp,
    ThemeAttributes: () => Yf,
    VoiceDisconnect: () => Zf,
    WindowPrefs: () => xp
});
var na = ze(require("fs"), 1),
    Ts = ze(require("path"), 1),
    $f = ze(require("electron"), 1);
ee();
Ne();
me();
Et();
...
var Cr = {
        ...ne(a => a.wrapper && a.icon && a.selected && a.selectable && !a.mask, {
            firstId: 60090,
            cacheId: "core-commandmanager-iconClasses"
        }),
        builtInSeparator: ne(a => a.builtInSeparator, {
            firstId: 681755,
            cacheId: "core-commandmanager-builtInSeparatorClasses"
        })?.builtInSeparator
    },
    ex = a => a?.replace(/'s /g, " ").match(/\b\w/g)?.join("").slice(0, 2) ?? "",
    tx = a => {
        try {
            let e = new URL(a);
    ...
    es = class a {
        static #e = new Map;
        static #t = new Map;
        static User = Pt(["hasHadPremium(){"], {
            firstId: 427157,
            cacheId: "core-commandmanager-user"
        });
        static createBotMessage = Pt(['username:"Clyde"'], {
            searchExports: !0,
            firstId: 963852,
        ...
        static #o() {
            let e = Pt([".BUILT_IN?", "categoryListRef:"], {
                defaultExport: !1
            });
            q.after("CommandManager", e, "A", (t, [o], r) => {
        ...
        static #r() {
            let [e, t] = Dt(N.byStrings(".getScoreWithoutLoadingLatest"), {
                firstId: 264322,
                cacheId: "core-commandmanager-indexstore"
            });
            q.after("CommandManager", e, t, (o, r, n) => {
                if (!r[2].commandTypes.includes(Sr.CHAT_INPUT)) return n;
        ...
        static #i() {
            let e = Aa("ApplicationCommandIndexStore");
            q.after("CommandManager", e, "query", (t, o, r) => {
                if (!o[1].commandTypes.includes(Sr.CHAT_INPUT)) return r;
                let n = o[1].text || "";
        ...
        static #s() {
            let [e, t] = Dt(N.byStrings(".type===", ".BUILT_IN?"), {
                target: ne((o, r) => gn[r.id].toString().includes("hasSpaceTerminator:"), {
                    firstId: 826298,
                    cacheId: "core-commandmanager-appIcons"
                })
            });
            q.after("CommandManager", e, t, (o, [{
                id: r
            }], n) => {
                let d = (() => {
                        let c = ie.resolveAddon(r)?.icon || ie.resolveAddon(r)?.instance?.icon || null,
                    ...
                    u = ({
                        ...
                        let I = [y && Cr.selectable, g && Cr.selected, Cr.wrapper, Cr.icon, h].filter(Boolean).join(" "),
                            R = {
                                width: c,
                                height: f,
                                padding: m
                            ...
                            L = () => typeof d == "function" ? i.createElement(d) : typeof d == "string" && tx(d) ? E() : H();
                        return i.createElement("div", {
                            style: R,
                            className: I
                        }, L())
        ...
        static #d() {
            let [e, t] = Dt(N.byStrings("openOAuth2Modal", "Promise.resolve", "commandIntegrationTypes"), {
                firstId: 972995,
                cacheId: "core-commandmanager-authorizer"
            });
            q.instead("CommandManager", e, t, (o, r, n) => this.#t.has(r[0]?.applicationId) ? Promise.resolve({
                isAuthorized: !0
            }) : n.apply(o, r))
        }
        ...
        static #c(e) {
            return (t, {
                ...
                try {
                    ...
                    return (!("inputType" in e) || e.inputType === Un.BUILT_IN) && this.sendBotMessage(n, {
                        channel: o,
                        guild: r
                    }), n
                } catch (n) {
...
var Y = class {
    ...
    async initialize() {
        k.get(this.collection, this.category, this.id) && await this.enable(), F.on("setting-updated", (e, t, o, r) => {
            e != this.collection || t !== this.category || o !== this.id || (r ? this.enable() : this.disable())
        }), this.initialized = !0
    }
    registerSetting(e, t, o, r, n) {
        return arguments.length == 4 ? (e = this.collection, t = arguments[0], o = arguments[1], r = arguments[2], n = arguments[3]) : arguments.length == 3 && (e = this.collection, t = this.category, o = arguments[0], r = arguments[1], n = arguments[2]), k.on(e, t, o, s => {
            s ? r() : n()
        })
    }
    get(e, t, o) {
        return arguments.length == 2 ? (e = this.collection, t = arguments[0], o = arguments[1]) : arguments.length == 1 && (e = this.collection, t = this.category, o = arguments[0]), k.get(e, t, o)
    }
    async enable() {
        this.log("Enabled");
        try {
    ...
    before(e, t, o) {
        return q.before(this.name, e, t, o)
    }
    instead(e, t, o) {
        return q.instead(this.name, e, t, o)
    }
    after(e, t, o) {
        return q.after(this.name, e, t, o)
    }
    unpatchAll() {
        return q.unpatchAll(this.name)
    }
    addCommands(...e) {
        for (let t of e) {
            let o = aa.registerCommand("BetterDiscord", t);
            this.#e.add(o)
        }
    }
    removeCommands() {
...
A();
var hf = "Minified React error #460; visit https://react.dev/errors/460 for the full message or use the non-minified dev environment for full errors and additional helpful warnings.",
    mf = Symbol("no-resolve"),
    ax = {
        use(a) {
    ...
    jn = {
        ...
        getOwnerInstance(a, {
            ...
            let l = jn.getInternalInstance(a);
            for (; l && l.return;) {
                l = l.return;
                let u = l.stateNode;
        ...
        wrapInHooks(a, e = {}) {
            ...
            return function(r) {
                ...
                Object.assign(n, ax, e);
                try {
                    return t(r)
                } catch (d) {
                    if (d instanceof Error && d.message === hf) return;
                    throw d
                } finally {
                    Object.assign(n, s)
                }
...
var qn = new class {
    get discordLocale() {
        return Me.LocaleStore?.locale ?? this.defaultLocale
    }
    get defaultLocale() {
        return "en-US"
    }
    initialize() {
        Ni.setLocale(this.discordLocale), Me.LocaleStore?.addChangeListener(() => Ni.setLocale(this.discordLocale))
    }
};
A();
me();
G();
var os = "betterdiscord.app",
    yf = "v3",
    So = (...a) => {
    ...
    Wn = (...a) => {
        let e = a.map(t => t.match(/\/*(.+)\/*/)?.[1]).filter(Boolean).join("/");
        return `https://api.${os}/${yf}/${e}`
    },
    as = a => e => So(`${a}/${encodeURIComponent(e)}`),
    Hn = a => e => So(`${a}?id=${e}`),
    gf = {
    ...
    ox = !0,
    bf = /^https:\/\/raw\.githubusercontent\.com\/(.+?)\/(.+?)\/(.+?)\/(.+)$/,
    re = class a {
        static getReleaseChannelType(e) {
            if (gf.plugin.includes(e)) return "plugin";
            if (gf.theme.includes(e)) return "theme"
        }
        ...
        static API_VERSION = yf;
        static hostname = os;
        static redirects = {
            github: Hn("/gh-redirect"),
        ...
        static pages = {
            ...
            plugins: So("/plugins"),
            plugin: as("/plugin"),
            developers: So("/developers"),
            developer: as("/developer")
        };
        static resources = {
            EMPTY_THUMBNAIL: ox ? "/resources/store/missing.svg" : "/resources/ui/content_thumbnail.svg",
            thumbnail: e => So(e || a.resources.EMPTY_THUMBNAIL)
        };
        static store = {
            addons: Wn("/store/addons"),
            themes: Wn("/store/themes"),
            plugins: Wn("/store/plugins"),
            addon: e => Wn(`/store/${encodeURIComponent(e)}`),
            tags: {
...
A();
Z();
var rx = C.AccessibilityContext || i.createContext({
        reducedMotion: {
            enabled: !1
        }
    }),
    oa = xf.Type = Object.freeze({
...
function xf(a) {
    let {
        ...
        let s = a.type || oa.WANDERING_CUBES;
        if (!e?.enabled) return s;
        switch (s) {
            case oa.WANDERING_CUBES:
            case oa.CHASING_DOTS:
                return oa.LOW_MOTION;
            default:
                return s
        }
    ...
    switch (o) {
        case oa.SPINNING_CIRCLE:
        case oa.SPINNING_CIRCLE_SIMPLE:
            return i.createElement("div", {
                className: r,
                role: "img",
                ...
                viewBox: "25 25 50 50"
            }, o === oa.SPINNING_CIRCLE && i.createElement(i.Fragment, null, i.createElement("circle", {
                cx: 50,
                cy: 50,
                r: 20,
                className: n
        ...
        default:
            return i.createElement("span", {
                ...
                className: n
            }), (o === oa.PULSING_ELLIPSIS || o === oa.LOW_MOTION) && i.createElement("span", {
                className: n
            })))
    }
}
var at = Object.freeze(xf);
A();
G();
Z();
we();
...
var {
    useCallback: nx
} = i, ix = "bd-settings-title", sx = "bd-settings-title bd-settings-group-title";
...
function Vn({
    ...
    let {
        ...
        toggleStore: r,
        showingStore: n
    } = i.useContext(Lo), s = i.useCallback(() => {
        n && r()
    }, [n, r]);
    return i.useContext(ra)(i.createElement(vt, {
        text: i.createElement("div", {
            className: "bd-addon-title",
            "data-showing-store": n
        }, i.createElement("span", {
            onClick: s
        }, o), n && i.createElement(i.Fragment, null, i.createElement(Gt, {
            size: "24px"
...
function lx({
    ...
    let [e, t] = ns(() => a.hash?.trim() ? 0 : 2), o = dx();
    return vf(() => {
...
function is({
    ...
    let [r, n] = ns(() => k.get("settings", "store", "alwaysEnable")), s = Kn(() => a.openAuthorPage(), [a]), d = Kn(() => a.guild.join(), [a]), l = Kn(() => a.openSourceCode(), [a]), [u, c] = ns(!1), f = Kn(() => {
        c(!0), t(r).catch(() => o())
    }, [t, r, o]);
    return vf(() => {
        ...
        return F.on(`${a.type}-loaded`, m), () => F.off(`${a.type}-loaded`, m)
    }, [a, o]), i.createElement(Ae, {
        transitionState: e,
        size: Ae.Sizes.SMALL,
        ...
        leading: i.createElement(pr, {
            size: "24px"
        }),
        content: a.version
    }), i.createElement(Io, {
        leading: i.createElement(Ko, {
            size: "24px"
        }),
        content: a.lastModified.toLocaleString(qn.discordLocale)
    }), i.createElement(Io, {
        leading: i.createElement(yt, {
            size: "24px"
        }),
        content: a.filename,
        action: l
    }), i.createElement(Io, {
        leading: i.createElement(hr, {
            size: "24px"
        }),
        content: a.author,
        action: s
    }), a.guild && i.createElement(Io, {
        leading: i.createElement(st, {
            size: "24px"
        }),
        ...
        type: at.Type.PULSING_ELLIPSIS
    }) : p("Addons.downloadAddon")), i.createElement(rs, {
        value: r,
        onChange: n,
...
function ux(a) {
    return new Promise(e => {
        B.showConfirmationModal(p("Modals.confirmAction"), p("Addons.confirmDelete", {
            name: a.name
        }), {
            danger: !0,
...
var $n = class {
        ...
        join() {
            B.showGuildJoinModal(this.invite)
        }
    },
    ya = class a {
        id;
        ...
        static from(e) {
            if (typeof this.cache[e.id] == "object") {
                ...
                return t.guild = o ? $n.from(o) : null, t.latestSourceUrl = e.latest_source_url, t.version = e.version, t.description = e.description, t.tags = e.tags, t.thumbnail = re.resources.thumbnail(e.thumbnail_url), t._addon = e, t
            }
            return new this(e)
        }
        constructor(e) {
            ...
            this.guild = t ? $n.from(t) : null, this.manager = e.type === "plugin" ? ie : Le, this.description = e.description, this.tags = e.tags, this.downloads = e.downloads, this.likes = e.likes, this.version = e.version, this.filename = e.file_name, this.latestSourceUrl = e.latest_source_url, this._addon = e, a.cache[e.id] = this
        }
        isUnknown() {
            return ss.isUnknown(this.filename)
        }
        markAsKnown() {
            ss.markAsKnown(this.filename)
        }
        openPreview() {
        ...
        async download(e = !1) {
            if (this.isInstalled()) {
                W.show(p("Addons.alreadyInstalled", {
                    name: this.name
                }), {
                    type: "info"
                });
            ...
            let t = o => new Promise((r, n) => {
                la(re.redirects.github(this.id.toString()), {
                    headers: {
                    ...
                    try {
                        ...
                        kf.default.writeFileSync(wf.default.join(this.manager.addonFolder, this.filename), l), W.show(p("Addons.successfullyDownload", {
                            name: this.name
                        }), {
                            type: "success"
                        }), this.downloads++
                    } catch (u) {
                        b.stacktrace("AddonStore", `Failed to fetch addon '${this.filename}':`, u), W.show(p("Addons.failedToDownload", {
                            context: this.type,
                            name: this.name
                        }), {
                            type: "error"
            ...
            return this._download ??= new Promise(o => {
                ...
                if (e) return t(k.get("settings", "store", "alwaysEnable")).finally(() => r());
                let n = !1,
                    s = B.ModalActions.openModal(d => i.createElement(is, {
                        ...d,
                        addon: this,
                        install: l => (n = !0, t(l))
                    }), {
        ...
        async delete(e = !1) {
            ...
            t && (!e && !await ux(t) || this.manager.deleteAddon && this.manager.deleteAddon(t))
        }
        isInstalled() {
    ...
    ss = new class {
        ...
        _useCache() {
            for (let e in this._cache.addons) Object.prototype.hasOwnProperty.call(this._cache.addons, e) && this.addons.push(new ya(this._cache.addons[e]))
        }
            ...
            return typeof t == "object" ? Promise.resolve(t) : this._singleAddonCache[e] ??= new Promise((o, r) => {
                la(re.store.addon(e), {
                    ...
                    try {
                        ...
                        this._singleAddonCache[l.name] = this._singleAddonCache[e], this._singleAddonCache[l.id] = this._singleAddonCache[e], o(ya.from(l))
                    } catch (l) {
                        b.stacktrace("AddonStore", `Failed to fetch ${e}`, l), W.show(p("Addons.failedToFetch"), {
                            type: "error"
        ...
        getAddon(e) {
            ...
            for (let o in ya.cache)
                if (Object.prototype.hasOwnProperty.call(ya.cache, o)) {
                    let r = ya.cache[o];
        ...
        async requestAddons(e = !1) {
            ...
            let t = !1,
                o = () => {
                    window.removeEventListener("offline", o), t = !0, this.loading = !1, b.debug("AddonStore", "User is offline waiting for connection..."), window.removeEventListener("online", this._onLineListener), window.addEventListener("online", this._onLineListener), W.show(p("Addons.failedToFetch"), {
                        type: "error"
            ...
            la(re.store.addons, {
                ...
                try {
                    ...
                    for (let f of l) this.addons.push(ya.from(f)), c.addons[f.file_name.toLowerCase()] = f, u && c.known.push(f.file_name);
                    this._writeCache(c), this.error = null
                } catch (l) {
                    b.stacktrace("AddonStore", "Failed to request addons", l), W.show(p("Addons.failedToFetch"), {
                        type: "error"
...
function Ir({
    ...
    let [t, o] = ds(() => a.isInstalled()), [r, n] = ds(!1), [s, d] = ds(a.downloads), [l, u] = fx(Lr), c = Ga(L => a.delete(L.shiftKey), [a]), f = Ga(async L => {
        n(!0), await a.download(L.shiftKey), d(a.downloads), n(!1)
    }, [a]), m = Ga(() => a.guild.join(), [a]), h = Ga(() => a.openSourceCode(), [a]), g = Ga(() => a.openAddonPage(), [a]), y = Ga(() => a.openPreview(), [a]), I = Ga(() => a.openAuthorPage(), [a]);
    cx(() => {
        let L = () => {
            o(a.isInstalled())
        };
        return L(), F.on(`${a.manager.prefix}-loaded`, L), F.on(`${a.manager.prefix}-unloaded`, L), () => {
            F.off(`${a.manager.prefix}-loaded`, L), F.off(`${a.manager.prefix}-unloaded`, L)
        }
    }, [a]);
    let R = Cf(() => {
    ...
    return i.createElement("div", {
        ...
        src: a.thumbnail,
        onError: L => {
            L.currentTarget.src = re.resources.thumbnail()
        },
        loading: "lazy",
    ...
    }, i.createElement(Gn, null), i.createElement("span", null, a.name)), i.createElement("div", {
        className: "bd-addon-store-card-description"
    }, a.description), i.createElement("div", {
        className: "bd-addon-store-card-tags"
    }, a.tags.map(L => i.createElement("span", {
        className: O({
            "bd-addon-store-card-tag": !0,
            "bd-addon-store-card-tag-selected": l(L)
        }),
        onClick: () => u(L)
...
function wt({
    ...
    let [n, s] = If(a ?? e[0].value), [d, l] = If(!1), {
        value: u,
        disabled: c
    ...
    xx(() => {
        ...
        d && y.current?.scrollIntoView({
            block: "center",
            behavior: "instant"
        })
    }, [d]);
    let R = e.find(E => E.value == f) ?? e[0];
    ...
    }, R.label), i.createElement(Ma, {
        size: "16px",
        className: "bd-select-arrow"
    })), i.createElement("ul", {
        ref: g,
        onToggle: E => l(E.newState === "open"),
        popover: "auto",
        role: "listbox",
        className: "bd-select-options bd-scroller-thin"
    }, e.map(E => i.createElement("li", {
        ref: R.value == E.value ? y : null,
        className: O("bd-select-option", R.value == E.value && "selected"),
        role: "option",
        onClick: () => I(E.value)
    }, E.label))))
}
...
function Ar(a) {
    ...
    }, a.image ? a.image : i.createElement(wx, null), i.createElement("div", {
...
function Sx({
    ...
    let o = i.useRef(null),
        r = i.useRef(null),
        n = Ao(() => re.store.tags[a], [a]),
        s = Ao(() => Object.entries(e).filter(([, d]) => d).map(([d]) => d), [e]);
    return i.useEffect(() => {
        let d = o.current,
            l = r.current;
        if (!d || !l) return;
        ...
        className: "bd-select-value"
    }, s.length, "/", n.length), i.createElement(Ma, {
        className: "bd-select-arrow",
        size: "16px"
    })), i.createElement("ul", {
        ref: r,
...
function fs({
    ...
    let {
        ...
        addons: o,
        loading: r
    } = $e.useState(), [n, s] = Er(0), [d, l] = Er({}), u = Zn((ae, z) => {
        s(0), l(ue => ({
            ...ue,
            [ae]: z ?? !ue[ae]
        }))
    ...
    }, []), [h, g] = Er(() => _a(`${a}-store`, "sort", "downloads")), [y, I] = Er(() => _a(`${a}-store`, "ascending", !0)), R = Zn(ae => {
        Va(`${a}-store`, "ascending", ae), I(ae)
    }, [a]), E = Zn(ae => {
        Va(`${a}-store`, "sort", ae), g(ae)
    }, [a]), H = Ao(() => {
        let ae = c.toLowerCase();
        return o.filter(z => z.type !== a || !(z.name.toLowerCase().includes(ae) || z.author.toLowerCase().includes(ae) || z.description.toLowerCase().includes(ae)) ? !1 : Object.entries(d).every(([ue, Ce]) => Ce ? z.tags.includes(ue) : !0))
    }, [a, o, c, d]), L = Ao(() => {
        ...
        let z = H.concat().sort((ue, Ce) => {
            let K = 0;
            switch (h) {
                case "author":
                case "version":
                    K = ue[h].localeCompare(Ce[h]);
                    break;
                case "likes":
                case "downloads":
                    K = Ce[h] - ue[h];
                    break;
                case "isInstalled":
                    K = ue.isInstalled() === Ce.isInstalled() ? 0 : ue.isInstalled() ? -1 : 1;
                    break;
                case "modified":
                    K = Ce.lastModified - ue.lastModified;
                    break;
                case "releaseDate":
                    K = Ce.releaseDate - ue.releaseDate;
                    break;
                case "name":
                    break;
                default:
            ...
            return (K === 0 || isNaN(K)) && (K = ue.name.localeCompare(Ce.name)), y ? K : -K
        }).map(ue => i.createElement(pe, {
            key: ue.id
        }, i.createElement(Ir, {
            addon: ue
        })));
        return i.createElement(Cx, {
            content: z,
            refToScroller: e,
            setPage: s,
            page: n
        })
    }, [H, y, h, s, n, e, r]), T = Ao(() => a === "plugin" ? ie : Le, [a]);
    return [i.createElement(Vn, {
    ...
    }, Ha(p("Addons.openFolder", {
        context: a
    }), i.createElement(Da, {
        size: "20px"
    }), () => J.openPath(T.addonFolder), "folder"), Ha(p("Addons.reload"), i.createElement(dt, {
        size: "20px"
    }), () => r ? {} : $e.requestAddons(), "reload")), i.createElement("div", {
        ...
        className: "bd-label"
    }, p("Addons.tags"), ":"), i.createElement(Sx, {
        type: a,
        selected: d,
        onChange: u
    })), i.createElement("div", {
        ...
        className: "bd-label"
    }, p("Sorting.sortBy"), ":"), i.createElement(wt, {
        options: kx(),
        value: h,
        onChange: E,
        style: "transparent"
        ...
        className: "bd-label"
    }, p("Sorting.order"), ":"), i.createElement(wt, {
        options: _n(),
        value: y,
        onChange: R,
        style: "transparent"
        ...
        size: "24px"
    }), i.createElement("div", null, i.createElement("div", null, p("Addons.failedToFetch")), i.createElement("div", null, t.message))), i.createElement(Lr.Provider, {
        value: [ae => !!d[ae], u]
    }, L)]
}
A();
...
function Lx(a, e) {
    ...
    return a == "invite" && (o.props.onClick = function(r) {
        r.preventDefault(), r.stopPropagation(), B.showGuildJoinModal(e)
    }), Xn(p(`Addons.${a}`), o)
}
...
function ms({
    ...
    let u = ps(() => {
        ...
        c = ps(() => {
            ...
            let g = Eo(a.name);
            try {
                B.showAddonSettingsModal(g, l())
            } catch (y) {
                W.show(p("Addons.settingsError", {
                    name: g
                }), {
                    type: "error"
                }), b.stacktrace("Addon Settings", "Unable to get settings panel for " + g + ".", y)
            }
        }, [n, e, a.name, l]),
        f = ps(() => {
            if (!a.authorId || (Tf && Tf.popLayer(), !Mf || !zf || !Df || !Pf)) return;
            let g = Mf.getCurrentUser().id;
            if (g == a.authorId) return;
            let y = Df.getDMFromUserId(a.authorId);
            if (y) return zf.selectPrivateChannel(y);
            Pf.openPrivateChannel(g, a.authorId)
        }, [a.authorId]),
        m = Ef(() => {
            let g = p("Addons.byline").split(/({{[A-Za-z]+}})/),
                y = a.authorLink || a.authorId ? i.createElement("a", {
                    className: "bd-link bd-link-website",
                    href: a.authorLink || "",
                    onClick: f,
                    target: "_blank",
                    rel: "noopener noreferrer"
                }, Eo(a.author)) : i.createElement("span", {
                    className: "bd-author"
                }, Eo(a.author)),
                I = g.findIndex(R => R == "{{author}}");
            return I && (g[I] = y), [i.createElement("div", {
                className: "bd-name"
            }, Eo(a.name)), i.createElement("div", {
                className: "bd-meta"
            }, i.createElement("span", {
        ...
        h = Ef(() => {
            let y = Object.keys(Bf).map(I => Lx(I, a[I])).filter(I => I);
            return i.createElement("div", {
                className: "bd-footer"
            }, i.createElement("span", {
                className: "bd-links"
            ...
            }, n && Xn(p("Addons.addonSettings"), i.createElement(lr, {
                size: "20px"
            }), c, {
                isControl: !0,
                disabled: !e
            }), s && Xn(p("Addons.editAddon"), i.createElement(Zt, {
                size: "20px"
            }), s, {
                isControl: !0
            }), d && Xn(p("Addons.deleteAddon"), i.createElement(Ba, {
                size: "20px"
            }), d, {
                isControl: !0,
                danger: !0
    ...
    }, Oe.parseToReact(Eo(a.description)))), h)
}
ke();
ba();
xe();
...
function hs(a) {
    ...
    }, i.createElement(Ix, null), i.createElement("div", {
    ...
    }, Oe.parseToReact(a.message || p("Addons.blankSlateMessageGeneric"))), a.children)
}
me();
lt();
oe();
...
function Ex({
    ...
    let {
        toggleStore: t
    } = i.useContext(Lo), o = k.get("settings", "store", "bdAddonStore"), r = p("Addons.blankSlateMessage", {
        link: re.pages[`${a}s`],
        context: a
    }).toString(), n = o ? t : () => Ff(e), s = o ? "Addons.openStore" : "Addons.openFolder";
...
function Mx(a, e) {
    return function(t) {
        ...
        B.showConfirmationModal(p("Modals.confirmAction"), p("Addons.enableAllWarning", {
...
function Dx() {
    ...
    if (k.get("settings", "store", "bdAddonStore")) return i.createElement("div", {
...
function gs({
    ...
    let [e, t] = _t(""), [o, r] = _t(_a.bind(null, a.prefix, "sort", "name")), [n, s] = _t(_a.bind(null, a.prefix, "ascending", !0)), [d, l] = _t(_a.bind(null, a.prefix, "view", "list")), u = he(a, () => a.addonList.concat(), [a], !0), c = he(a, () => Object.assign({}, a.state), [a], !0), f = it(K => {
        a.toggleAddon(K)
    }, [a]), m = it(() => {
        a.enableAllAddons()
    }, [a]), h = it(() => {
        ...
        Va(a.prefix, "view", K), l(K)
    }, [a.prefix]), y = it(() => g("list"), [g]), I = it(() => g("grid"), [g]), R = it(K => {
        Va(a.prefix, "ascending", K), s(K)
    }, [a.prefix]), E = it(K => {
        Va(a.prefix, "sort", K), r(K)
    }, [a.prefix]), H = it(K => t(K.currentTarget.value.toLocaleLowerCase()), []), L = it(K => a.editAddon?.(K), [a]), T = it(async K => {
        let de = u.find($ => $.id == K);
        await Tx(de) && a?.deleteAddon?.(de)
    }, [u, a]), ae = yl(() => {
        let K = u.sort((de, Pe) => {
            let $ = o === "isEnabled",
                Re = $ ? c[de.id] : de[o],
                se = $ ? c[Pe.id] : Pe[o],
                le = (Ue, Ee) => Ue.toLocaleLowerCase().localeCompare(Ee.toLocaleLowerCase());
            return typeof Re == "string" && typeof se == "string" ? le(Re, se) : typeof Re == "boolean" && typeof se == "boolean" ? Re === se ? le(de.name, Pe.name) : Re ? -1 : 1 : Re > se ? 1 : se > Re ? -1 : 0
        });
        return n || K.reverse(), e && (K = K.filter(de => {
            let Pe = de.name.toLocaleLowerCase().includes(e);
            return Pe = Pe || de.author.toLocaleLowerCase().includes(e), Pe = Pe || de.description.toLocaleLowerCase().includes(e), !!Pe
        })), K.map(de => {
            let Pe = de.instance && typeof de.instance.getSettingsPanel == "function",
                $ = Pe && de.instance.getSettingsPanel.bind(de.instance);
    ...
    }, [a, u, c, f, T, L, e, n, o]), z = u.length !== 0, ue = !!e, Ce = ae.length !== 0;
    return [i.createElement(Vn, {
        count: ae.length,
        searching: ue
    }, i.createElement(Ka, {
        ...
        size: "20px"
    }), Ff.bind(null, a.addonFolder), "folder"), Ha(p("Addons.enableAll"), i.createElement(Ye, {
        size: "20px"
    }), Mx(m, a.prefix), "enable-all"), Ha(p("Addons.disableAll"), i.createElement(We, {
        size: "20px"
    ...
    }, Nf(p("Addons.listView"), i.createElement(fr, {
        size: "20px"
    }), y, d === "list"), Nf(p("Addons.gridView"), i.createElement(Qo, null), I, d === "grid")))), i.createElement(Dx, null), !z && i.createElement(Ex, {
        type: a.prefix,
        folder: a.addonFolder
    }), ue && !Ce && z && i.createElement(Ar, null), z && i.createElement("div", {
        key: "addonList",
...
function bs(a) {
    let [e, t] = Px(() => k.get("settings", "store", "bdAddonStore") && !a.store.addonList.length), o = zx(() => t(r => !r), []);
    return i.createElement(Lo.Provider, {
        value: {
            toggleStore: o,
            showingStore: e,
            ...a
        }
    }, e ? i.createElement(fs, {
        ...a,
        type: a.store.prefix
    }) : i.createElement(gs, {
        ...a
...
function Bx() {
    if (typeof Jn > "u") {
        for (let e in _.m)
            if (Object.hasOwn(_.m, e) && String(_.m[e]).includes("releaseChannel:window.GLOBAL_ENV.RELEASE_CHANNEL")) {
                Jn = e;
                break
            }
    }
    let a = C.RemoteModule?.releaseChannel ?? window.GLOBAL_ENV?.RELEASE_CHANNEL ?? "unknown";
    if ((typeof Tr.buildNumber > "u" || typeof Tr.versionHash > "u") && typeof Jn < "u") {
        let e = String(_.m[Jn]);
        for (let t of e.matchAll(/(buildNumber|versionHash):"([^"]+)"/g)) Tr[t[1]] = t[2]
    }
    return `${a[0].toUpperCase()}${a.substring(1)} ${Tr.buildNumber||"unknown"} (${(Tr.versionHash||"unknown").substring(0,7)})`
}
...
function xs() {
    return `${V.isCanary?"Canary":"Stable"} ${V.get("version")} (${V.get("commit")?.substring(0,7)})
`
}
...
\`\`\``), !Ux.has(t)) return e(1);
        let f = a + 1;
        f > kt || (f === kt && k.set("developer", "canary", !o), e(f))
    }, [a, t, o]), s = Rf(() => {
        setTimeout(() => e(0), 250)
    }, []), d = he(ie, () => Mr(ie), [], !0), l = he(Le, () => Mr(Le), [], !0), u = Yn(() => {
        if (a === 0) return "Click to copy";
        if (a > 0 && a < kt / 2) return "Copied";
        if (a >= kt / 2 && a < kt) return `${kt-a} clicks to go`;
        if (a >= kt) return o ? "Switched to BD canary" : "Switched to BD stable"
    }, [a, o]), c = Yn(() => {
        if (a === 0) return "primary";
        if (a > 0 && a < kt / 2) return "green";
        if (a >= kt / 2 && a < kt) return "yellow";
        if (a >= kt) return "brand"
    }, [a]);
    return i.createElement(C.Tooltip, {
        color: c,
        position: "top",
...
function To({
    ...
    let d = Wx(null),
        ...
        m = `${Hx} ${e?`collapsible ${l?"collapsed":"expanded"}`:""}`;
    return i.createElement("div", {
        className: m
    }, i.createElement(vt, {
        text: a,
...
function Pr({
    ...
    let [s, d] = _x(a), {
        value: l,
        disabled: u
    } = Vx(Ie), c = l !== fe ? l : s, f = l !== fe ? u : n, m = ws(y => {
        r?.(y.target.value), d(y.target.value)
    }, [r]), h = ws(() => {
        let I = parseFloat(String(c)) + o;
        t !== void 0 && I > t || (r?.(I), d(I))
    }, [r, c, t, o]), g = ws(() => {
        let I = parseFloat(String(c)) - o;
        e !== void 0 && I < e || (r?.(I), d(I))
    }, [r, c, e, o]);
    return i.createElement("div", {
...
function zr({
    ...
    let [s, d] = Gx(a), {
        value: l,
        disabled: u
    } = $x(Ie), c = l !== fe ? l : s, f = l !== fe ? u : n, m = Kx(h => {
...
function Br({
    ...
    let [l, u] = Zx(a), {
        value: c,
        disabled: f
    } = Yx(Ie), m = c !== fe ? c : l, h = c !== fe ? f : n, g = Jx(null), y = Qn(L => {
        h || (r?.(L.target.value), u(L.target.value))
    }, [r, h]), I = Qn(L => {
        h || (r?.(L), u(L))
    }, [r, h]), R = Qn(L => (L - e) * 100 / (t - e), [e, t]), E = Xx(() => {
        let L = -37.5 / (t - e),
            T = m * L + -25;
        return T < -62.5 ? -62.5 : T
    }, [m, e, t]), H = Qn(L => {
        let T = L.currentTarget.getBoundingClientRect(),
            ue = (L.clientX - T.left) / T.width * (t - e) + e;
        g.current.value = ue.toString(), I(g.current.value)
    }, [t, e, I, g]);
    return i.createElement("div", {
        ...
        let T = typeof L == "number" ? L : L.value,
            ae = typeof L == "number" ? L : L?.label,
            z = s && typeof L == "number";
        return i.createElement("div", {
...
function Nr({
    ...
    let {
        value: n,
        disabled: s
    } = tv(Ie), d = n !== fe ? n : e, l = n !== fe ? s : r, [u, c] = Qx(t.findIndex(h => h.value === d)), f = ev(h => {
        if (l) return;
    ...
    function m(h, g) {
        ...
        return i.createElement("label", {
            className: "bd-radio-option" + (y ? " bd-radio-selected" : ""),
            style: {
...
function Fr({
    ...
    let [n, s] = Uf({
        ...
        value: u,
        disabled: c
    } = rv(Ie), f = u !== fe ? u : d, m = u !== fe ? c : r;
    ov(() => (window.addEventListener("keydown", h, !0), window.addEventListener("keyup", g, !0), () => {
        window.removeEventListener("keydown", h, !0), window.removeEventListener("keyup", g, !0)
    }));
    let h = ei(E => {
            n.isRecording && (E.stopImmediatePropagation(), E.stopPropagation(), E.preventDefault(), !(E.repeat || n.accum.includes(E.key)) && (n.accum.push(E.key), n.accum.length == t && (s({
                isRecording: !1,
                accum: []
            }), l(n.accum.slice(0)), e?.(n.accum))))
        }, [n, t, e]),
        g = ei(E => {
            n.isRecording && (E.stopImmediatePropagation(), E.stopPropagation(), E.preventDefault(), E.key === n.accum[0] && (s({
                isRecording: !1,
                accum: []
            }), l(n.accum.slice(0)), e?.(n.accum)))
        }, [n, e]),
        y = ei(E => {
            E.stopPropagation(), E.preventDefault(), !m && (e && e([]), l([]), s({
                ...n,
                isRecording: !1,
                accum: []
            }))
        ...
        I = ei(E => {
            if (!m) {
                if (E.currentTarget?.className?.includes?.("bd-keybind-clear") || E.currentTarget?.closest(".bd-button")?.className?.includes("bd-keybind-clear")) return y(E);
                s({
                    ...n,
        ...
        R = f.length ? f.map(E => E === "Control" ? "Ctrl" : E).join(" + ") : "";
    return i.createElement("div", {
        ...
        size: w.Sizes.ICON,
        look: w.Looks.FILLED,
        color: n.isRecording ? w.Colors.RED : w.Colors.PRIMARY,
...
var {
    ...
    useCallback: iv,
    useContext: sv
} = i, dv = [1752220, 3066993, 3447003, 10181046, 15277667, 15844367, 15105570, 15158332, 9807270, 6323595, 1146986, 2067276, 2123412, 7419530, 11342935, 12745742, 11027200, 10038562, 9936031, 5533306];
...
var lv = a => {
    ...
    uv = a => {
        let e = typeof a == "string" ? lv(a) : a;
        return .2126 * e[0] + .7152 * e[1] + .0722 * e[2]
    },
    ks = a => uv(a) >= 150 ? "#000" : "#fff";
...
function Or({
    ...
    let [n, s] = nv(a), {
        value: d,
        disabled: l
    } = sv(Ie), u = d !== fe ? d : n, c = d !== fe ? l : r, f = iv(h => {
        c || (e?.(Ut(h.target.value)), s(h.target.value))
    }, [e, c]), m = Ut(u, !1);
    return i.createElement("div", {
...
function Ss({
    ...
    let s = cv(null),
        d = Cs(c => {
            if (r) return;
            let f = [];
            for (let m of c.target.files) f.push(jf.webUtils.getPathForFile(m));
            o?.(a === !0 ? f : f[0])
        }, [o, r, a]),
        l = Cs(() => {
...
lt();
xt();
var pv = ["top-left", "top-right", "bottom-left", "bottom-right"],
    mv = ({
        value: a,
        onChange: e,
        disabled: t
        ...
        let [o, r] = _t(a), {
            value: n,
            disabled: s
        } = Sn(Ie), d = n !== fe ? n : o, l = n !== fe ? s : t, u = f => {
            l || (e?.(f), r(f))
        ...
        }, pv.map(f => i.createElement("button", {
            key: f,
            className: c(f),
            onClick: () => u(f),
            role: "radio",
...
function ti(a) {
    let e = null;
    return a.type === "dropdown" && (e = i.createElement(wt, {
        ...a
    })), a.type === "number" && (e = i.createElement(Pr, {
        ...a
    })), a.type === "switch" && (e = i.createElement(Yt, {
        ...a
    })), a.type === "text" && (e = i.createElement(zr, {
        ...a
    })), a.type === "file" && (e = i.createElement(Ss, {
        ...a
    })), a.type === "slider" && (e = i.createElement(Br, {
        ...a
    })), a.type === "radio" && (e = i.createElement(Nr, {
        ...a
    })), a.type === "keybind" && (e = i.createElement(Fr, {
        ...a
    })), a.type === "color" && (e = i.createElement(Or, {
        ...a
    })), a.type === "button" && (e = i.createElement(w, {
        ...a
    })), a.type === "position" && (e = i.createElement(qf, {
        ...a
    })), a.type === "custom" && (e = a.children), e ? i.createElement(xa, {
        id: a.id,
...
function yv(a) {
    return () => {
        B.showConfirmationModal(p("Modals.confirmAction"), p("Settings.resetSettingsWarning"), {
            confirmText: p("Modals.okay"),
            cancelText: p("Modals.cancel"),
            danger: !0,
            onConfirm: a
...
function Ls({
    ...
    let s = i.useContext(ra);
    return i.createElement(i.Fragment, null, s(i.createElement(vt, {
        text: e
    }, bv(a))), t.map(d => {
...
var xv = {
    ...
    Rr = (a, e = t => t) => bl(t => i.createElement(a, e({
        size: xv[t.size || "md"],
...
xe();
oe();
var vv = typeof Ta.render == "function" ? Ta.render : Ta,
    Wf = (a, e) => {
        let t = {
            d: a
        };
    ...
    Is = a => {
        let e = vv({
            ...
            iconNode: [Wf("M1402.2,631.7c-9.7-353.4-286.2-496-642.6-496H68.4v714.1l442,398V490.7h257c274.5,0,274.5,344.9,0,344.9H597.6v329.5h169.8c274.5,0,274.5,344.8,0,344.8h-699v354.9h691.2c356.3,0,632.8-142.6,642.6-496c0-162.6-44.5-284.1-122.9-368.6C1357.7,915.8,1402.2,794.3,1402.2,631.7z", a.accent ? "var(--bd-brand)" : a.color || "currentcolor"), Wf("M1262.5,135.2L1262.5,135.2l-76.8,0c26.6,13.3,51.7,28.1,75,44.3c70.7,49.1,126.1,111.5,164.6,185.3c39.9,76.6,61.5,165.6,64.3,264.6l0,1.2v1.2c0,141.1,0,596.1,0,737.1v1.2l0,1.2c-2.7,99-24.3,188-64.3,264.6c-38.5,73.8-93.8,136.2-164.6,185.3c-22.6,15.7-46.9,30.1-72.6,43.1h72.5c346.2,1.9,671-171.2,671-567.9V716.7C1933.5,312.2,1608.7,135.2,1262.5,135.2z", a.secondaryColor || a.color || "currentcolor")]
        }, a.ref);
...
var Do = !1,
    ...
    ge = {
        Separator: Xa?.MenuSeparator,
        CheckboxItem: Xa?.MenuCheckboxItem,
        RadioItem: Xa?.MenuRadioItem,
        ControlItem: Xa?.MenuControlItem,
        Group: Xa?.MenuGroup,
        Item: Xa?.MenuItem,
        Menu: Xa?.Menu
    };
Do = Object.values(ge).every(a => a);
if (!Do) {
    let a = /(function .{1,3}\(.{1,3}\){return null}){5}/,
        ...
        r, n = "";
    for (let u in _.m)
        if (Object.prototype.hasOwnProperty.call(_.m, u) && a.test(_.m[u].toString())) {
            r = u;
            break
        } for (let u in _.m)
        if (Object.prototype.hasOwnProperty.call(_.m, u)) {
            let c = _.m[u].toString();
    ...
    d && (ge.Group ??= s[d[1]]);
    let l = n.match(o);
    l && (ge.Group ??= s[l[l[2] === "groupstart" ? 1 : 3]], ge.Item ??= s[l[l[2] === "customitem" ? 1 : 3]]), ge.Menu ??= ne(N.byStrings("getContainerProps()", ".keyboardModeEnabled&&null!="), {
        searchExports: !0,
        firstId: 397927,
...
var As = (() => {
    let a = {};
    try {
        Object.assign(a, ca(N.bySource("new DOMRect", "CONTEXT_MENU_CLOSE"), {
            closeContextMenu: N.byStrings("CONTEXT_MENU_CLOSE"),
            openContextMenu: N.byStrings("renderLazy")
        }, {
            searchDefault: !1,
            cacheId: "core-contextmenu-Actions"
        })), Do &&= typeof a.closeContextMenu == "function" && typeof a.openContextMenu == "function"
    } catch (e) {
        Do = !1, b.stacktrace("ContextMenu~Components", "Fatal startup error:", e), Object.assign(a, {
            closeContextMenu: () => {},
            openContextMenu: () => {}
        })
    }
...
var _f = new Wa,
    Mo = class a {
        static async contextMenuFixForLucide() {
            let e = await il(["colorDefault", "focused"], {
        ...
        static handleRender(e) {
            ...
            return _f.patch(t, (o, r, n) => (i.isValidElement(r) && (r.props.navId ? a.runPatches(r.props.navId, r, o, n) : r.type && typeof r.type != "string" && a.patchRecursive(r)), r)), t.type
        }
        static initialize() {
            if (!Do) return b.warn("ContextMenu~Patcher", "Startup wasn't successful, aborting initialization.");
        ...
        static patch(e, t) {
            if (typeof e == "string" && e.includes("*") && (e = Hf(e)), typeof e == "object") {
    ...
    Ur = class {
        patch(e, t) {
            return Mo.patch(e, t), () => Mo.unpatch(e, t)
        }
        unpatch(e, t) {
            Mo.unpatch(e, t)
        }
        buildItem(e) {
            ...
            if (t === "separator") return i.createElement(ge.Separator);
            let o = ge.Item;
            if (t === "submenu" ? e.children || (e.children = this.buildMenuChildren(e.render || e.items)) : t === "toggle" || t === "radio" ? (o = t === "toggle" ? ge.CheckboxItem : ge.RadioItem, e.active && (e.checked = e.active)) : t === "control" && (o = ge.ControlItem), e.id || (e.id = `${e.label.replace(/^[^a-z]+|[^\w-]+/gi,"-")}`), e.danger && (e.color = "danger"), e.onClick && !e.action && (e.action = e.onClick), e.extended = !0, t === "toggle") {
        ...
        buildMenuChildren(e) {
            let t = r => r.type === "group" ? o(r) : this.buildItem(r),
                o = function(r) {
                    ...
                    return i.createElement(ge.Group, null, n)
                };
            return e.map(t).filter(r => r)
        }
        buildMenu(e) {
            return t => i.createElement(ge.Menu, t, this.buildMenuChildren(e))
        }
        open(e, t, o) {
            return As.openContextMenu(e, function(r) {
                return i.createElement(t, Object.assign({}, r, {
                    onClose: As.closeContextMenu
                }))
            }, o)
        }
        close() {
        ...
        CheckboxItem = ge.CheckboxItem;
        RadioItem = ge.RadioItem;
        ControlItem = ge.ControlItem;
        Group = ge.Group;
        Item = ge.Item;
        Menu = ge.Menu
    };
Object.freeze(Ur);
Object.freeze(Ur.prototype);
try {
    Mo.initialize()
} catch (a) {
...
var Vf = new class {
        ...
        getAddonPanel(e, t = {}) {
            return o => i.createElement(bs, Object.assign({}, {
                title: e,
                ...o
            }, t))
        }
                    ...
                    buildLayout: () => {
                        let r = [],
                            ...
                            s = d => {
                                ...
                                function c() {
                                    let [f, m] = i.useState();
                                    return u = vr()[1], i.createElement(i.Fragment, null, i.createElement("div", {
                        ...
                        for (let d of k.panels.sort((l, u) => l.order > u.order ? 1 : -1)) {
                            d.type === "addon" && !d.element && (d.element = this.getAddonPanel(d.label, {
                                store: d.manager
                            }));
                            let l = d.icon ? Rr(d.icon) : () => d.id;
                            if (d.id === "customcss") {
                                n("customcss_tab", {
                            ...
                            n(d.id, {
                                ...
                                icon: l,
                                title: () => d.label,
                                useMenu: d.type === "addon" ? () => Lv(d.manager) : void 0,
                                useSearchTerms: () => [d.label, typeof d.searchable == "function" ? d.searchable().filter(u => typeof u == "string") : []].flat()
                            })
                        }
                        return r
                    },
                    useTitle: () => Object.assign(i.createElement(Cv, null), {
                        toString: () => "BetterDiscord"
                    })
                });
            q.after("SettingsManager", e, "buildLayout", (r, n, s) => {
                let d = s.findIndex(l => l.key === "activity_section") + 1;
                d === -1 && (d = s.length), s.splice(d, 0, o)
            })
        }
        patchSettingsSearch() {
            let e = ca(".PRIVACY_AND_SAFETY_PERSISTENT_VERIFICATION_CODES]", {
                search: N.byStrings(".PRIVACY_AND_SAFETY_PERSISTENT_VERIFICATION_CODES]")
            }, {
                cacheId: "core-settings-search"
            });
            q.after("SettingsManager", e, "search", (t, o, r) => {
                r = {
                    ...r
                };
                ...
                for (let s of k.panels.sort((d, l) => d.order > l.order ? 1 : -1)) {
                    let d = {
                        label: s.label,
        ...
        async patchVersionInformation() {
            let e = await wn(["copyValue", "RELEASE_CHANNEL"], {
                versionDisplay: N.byStrings("copyValue", "RELEASE_CHANNEL")
            }, {
                searchDefault: !1,
                mapDeclarations: !0
            });
            q.instead("SettingsManager", e, "versionDisplay", () => i.createElement(vs, null))
        }
        openSettingsPage(e) {
            wv?.openUserSettings?.(`betterdiscord_${e==="customcss"?"customcss_tab":e}_panel`, {
                section: e
            })
        }
        forceUpdate() {
            ...
            if (!t) return;
            let o = ve(ut.getInternalInstance(t), r => r && r.getPredicateSections, {
    ...
    Ja = new ai,
    wv = te(["openUserSettings", "openUserSettingsFromParsedUrl"], {
        firstId: 840065,
        cacheId: "core-settings-usersettings"
    }),
    Gf = () => {
        let a = he(k, () => k.get("settings", "customcss", "openAction"));
...
function Cv() {
    ...
    return i.createElement(i.Fragment, null, i.createElement("div", {
    ...
    }, "BetterDiscord"), a && Ho.createPortal(i.createElement(C.Tooltip, {
        color: "primary",
        position: "top",
        ...
        color: w.Colors.TRANSPARENT,
        size: w.Sizes.NONE,
        onClick: () => B.showChangelogModal(cn)
    }, i.createElement(Jo, {
        className: "bd-icon",
        size: "16px"
    }))), a))
}
var ra = i.createContext(a => a);

function Kf(a) {
    Ja.close(), Vf.openSettingsPage(a)
}

function Sv(a) {
    let e = he(k, () => a.settings.map(t => ({
        id: t.id,
        name: t.name,
        settings: t.settings.filter(o => o.type === "switch" && !o.hidden).map(o => ({
            ...
            label: o.name,
            disabled: o.disabled,
            checked: k.get(a.id, t.id, o.id),
            action: () => k.set(a.id, t.id, o.id, !k.get(a.id, t.id, o.id))
        }))
    })), []);
    return i.createElement(i.Fragment, null, e.map(t => i.createElement(Ja.Item, {
        label: t.name,
        id: t.id,
        action: () => Kf(a.id),
        key: `bd.${a.id}.${t.id}`
    }, t.settings.map(o => i.createElement(Ja.CheckboxItem, {
        ...o,
...
function Lv(a) {
    let e = he(a, () => a.addonList.map(r => r.name || r.getName?.()).sort((r, n) => r.toLowerCase().localeCompare(n.toLowerCase())).map(r => [r, a.resolveAddon(r), a.isEnabled(r)]), [], !0),
        t = he(k, () => k.get("settings", "store", "bdAddonStore"), []),
        o = i.useMemo(() => e.map(([r, n, s]) => i.createElement(Ja.CheckboxItem, {
            label: r,
            id: r,
            checked: s,
            key: `bd.${a.prefix}.${r}`,
            ...
            action: d => {
                ...
                l ? B.showAddonSettingsModal(r, u()) : W.warning(p("Addons.noSettings", {
                    name: r
                }))
            }
        })), [e, a]);
    return i.createElement(i.Fragment, null, i.createElement(Ja.Group, {
        key: `bd.${a.prefix}.installed`
    }, o), t && i.createElement(Ja.Group, {
        key: `bd.${a.prefix}.store`
    }, i.createElement(Ja.Item, {
        label: p("Addons.openStore", {
            context: a.prefix
        }),
        id: `${a.prefix}-store`,
        action: () => {
            Kf(a.prefix + "s"), P.onAdded(":where(.bd-store-card, .bd-addon-title > :nth-child(3))", r => r?.click())
        }
    })))
}
var Po = Vf;
...
var {
    ...
    Tv(u, () => ({
        ...
        set value(L) {
            c.current.setValue(L)
        },
        get hasUnsavedChanges() {
            return f
        }
    }), [f]), Av(() => (F.on("customcss-updated", h), () => F.off("customcss-updated", h)), [h]);
    let g = Ya(L => k.set("settings", "customcss", "liveUpdate", L), []),
        y = Ya((L, T) => o?.(T), [o]),
        I = Ya(() => t?.(), [t]),
        R = Ya((L, T) => l?.(T), [l]),
        E = Ya(L => {
    ...
    return i.createElement(Pn, {
        ...
        controls: [{
            ...
            type: "boolean",
            onChange: g,
            checked: k.get("settings", "customcss", "liveUpdate"),
            side: "right"
        }, l && {
            label: i.createElement($o, {
                size: "18px"
            }),
...
var Dv = Pt(["closeUserSettings"]),
    ...
    Ze = new class extends Y {
        ...
        get startDetached() {
            return k.get(this.collection, this.category, "openAction") == "detached"
        }
        get nativeOpen() {
            return k.get(this.collection, this.category, "openAction") == "system"
        }
        get startAsExternal() {
            return k.get(this.collection, this.category, "openAction") == "external"
        }
        get file() {
            return Ts.default.resolve(V.get("channelPath"), "custom.css")
        }
        savedCss;insertedCss;isDetached;watcher;constructor() {
            super(), this.savedCss = "", this.insertedCss = "", this.isDetached = !1
        }
        Page = () => [i.useContext(ra)(i.createElement(vt, {
            ...
            k.registerPanel(this.id, p("Panels.customcss"), {
                order: 2,
                icon: Zt,
                ...
                onClick: e => {
                    ...
                    let t = ve(e._reactInternals, o => o && o.onSetSection, {
        ...
        async disabled() {
            k.removePanel(this.id), this.unwatchContent(), this.insertCSS("")
        }
        watchContent() {
            if (this.watcher) return this.error("Already watching content.");
            if (!na.default.existsSync(this.file)) try {
                na.default.mkdirSync(Ts.default.dirname(this.file), {
                    recursive: !0
                }), na.default.writeFileSync(this.file, "")
            } catch (t) {
                return this.error("Could not create custom.css file.", t)
            }
            let e = {};
            this.log("Starting to watch content."), this.watcher = na.default.watch(this.file, {
                persistent: !1
            }, async (t, o) => {
                if (!t || !o) return;
                await new Promise(n => setTimeout(n, 50));
                try {
                    na.default.statSync(this.file)
                } catch (n) {
                    if (n.code !== "ENOENT") return;
                    delete e[o], this.saveCSS("")
                }
                let r = na.default.statSync(this.file);
                if (!(!r || !r.mtimeMs) && typeof r.mtimeMs == "number" && e[o] != r.mtimeMs && (e[o] = r.mtimeMs, t == "change")) {
                    let n = this.savedCss;
                    if (this.loadCSS(), n === this.savedCss) return;
                    this.insertCSS(this.savedCss), F.emit("customcss-updated", this.savedCss)
                }
            })
        }
        unwatchContent() {
        ...
        onChange(e) {
            k.get("settings", "customcss", "liveUpdate") && (this.insertCSS(e), this.saveCSS(e))
        }
        loadCSS() {
            try {
                this.savedCss = na.default.readFileSync(this.file).toString()
            } catch {
                this.savedCss = ""
            }
        }
        ...
        saveCSS(e) {
            typeof e < "u" && (this.savedCss = e), na.default.writeFileSync(this.file, this.savedCss)
        }
        open() {
            if (!this.isDetached) return this.nativeOpen ? this.openNative() : this.startDetached ? this.openDetached(this.savedCss) : this.startAsExternal ? this.openExternal() : Po.openSettingsPage(this.id)
        }
        openNative() {
            $f.default.shell.openExternal(`file://${this.file}`)
        }
        openDetached(e) {
            let t = i.createRef(),
                o = i.createElement(Es, {
                    ...
                    update: this.insertCSS.bind(this),
                    openNative: this.openNative.bind(this),
                    onChange: uo(this.onChange.bind(this), 500)
                });
            ta.open({
                onClose: () => {
                    this.isDetached = !1
                ...
                resizable: !0,
                children: o,
                confirmClose: () => !t || !t.current || k.get("settings", "customcss", "liveUpdate") ? !1 : t.current.hasUnsavedChanges,
                confirmationText: p("CustomCSS.confirmationText")
            }), this.isDetached = !0, !Dv?.() && (Pv?.close(), C.Dispatcher?.dispatch({
                type: "LAYER_POP"
            }))
        }
        openExternal() {
...
var Xf = new class extends Y {
    ...
    showModal() {
        this.initialized && B.showConfirmationModal(p("Modals.additionalInfo"), p("Modals.restartPrompt"), {
...
Je();
A();
var Jf = i.createContext({
        first: !1,
        last: !1
    }),
    Yf = new class extends Y {
        get name() {
        ...
        async patchMessage() {
            let e = await Wo(["Message must not be a thread starter message"], {
                cacheId: "core-themeattributes-MessageComponent",
                searchDefault: !1,
                declarationFilter: t => String(t.type).includes("Message must not be a thread starter message")
            });
            this.after(e, "type", (t, [o], r) => {
                let {
                    first: n,
                    last: s
                } = i.useContext(Jf), d = ve(r, c => c?.className?.includes("messageListItem"));
                if (!d) return;
                let l = ve(o, c => c?.username, {
                        walkable: ["message", "author"]
                    }),
                    u = l?.id;
                u && (d["data-author-id"] = u, d["data-author-username"] = l?.username, d["data-is-self"] = l.id === Me.UserStore?.getCurrentUser?.()?.id, d["data-is-webhook"] = l.discriminator === "0000" && l.bot, d["data-author-is-deleted"] = l.id === "456226577798135808", d["data-author-is-bot"] = l.bot && l.discriminator !== "0000", d["data-message-group-start"] = n, d["data-message-group-end"] = s, d["data-message-is-reply"] = o?.message?.messageReference?.type === 0, d["data-message-is-forward"] = o?.message?.messageReference?.type === 1)
            })
        }
        async patchMessageHook() {
            let e = await wn("SUMMARIES_UNREAD_BAR_VIEWED,{num_unread_summaries", {
                key: t => String(t?.type).includes("SUMMARIES_UNREAD_BAR_VIEWED,{num_unread_summaries")
            }, {
                cacheId: "core-themeattributes-messageHook",
                mapDeclarations: !0
            });
            this.after(e, "key", (t, o, r) => {
                let n = ve(r, l => l["data-list-id"] === "chat-messages", {
                    walkable: ["props", "children"]
                });
                if (!Array.isArray(n?.children)) return;
                let s = n.children.find(Array.isArray);
                if (!s) return;
                let d = [];
                for (let l = 0; l < s.length; l++) {
                    let u = s[l];
                    i.isValidElement(u) && typeof u.props.groupId == "string" && d.push([l, u])
                }
                if (d.length)
                    for (let l = 0; l < d.length; l++) {
                        let [u, c] = d[l], f = d[l + 1], m = d[l - 1], h = !0;
                        typeof m == "object" && (h = m[1].props.groupId !== c.props.groupId);
                        let g = !1;
                        f ? c.props.groupId !== f[1].props.groupId && (g = !0) : g = !0, s[u] = i.createElement(Jf, {
                            value: {
                                last: g,
                                first: h
                            }
        ...
        async patchVoiceUserComponent() {
            let e = await Pi(["userNameClassName:", "avatarContainerClass:"], {
        ...
        async patchTabBarComponent() {
            let e = await Pi(["({getFocusableElements:()=>{let"], {
                searchExports: !0,
                firstId: 158954,
        ...
        async patchUserProfileComponent() {
            let e = await Fe(t => t.render?.toString?.().includes("pendingThemeColors"), {
                firstId: 946356,
        ...
        async patchChatAvatar() {
            let e = await Fe(t => String(t.type).includes("showCommunicationDisabledStyles"), {
                cacheId: "core-themeattributes-ChatAvatar"
            });
            this.after(e, "type", (t, o, r) => {
                if (r.props.avatar) {
                    let n = ve(r.props.avatar, d => typeof d?.props?.children == "function");
                    if (!n || n.props.__bdPatched) return;
                    let s = n.props.children;
                    Object.assign(n.props, {
                        children(...d) {
                            let l = s.apply(this, d),
                                u = ve(l, c => c?.type === "img" && c?.props?.className?.includes("avatar") && c.props.ref, {
                                    walkable: ["props", "children"]
                                });
        ...
        async patchAvatars() {
            let e = await Wo(['.displayName="AvatarImg"'], {
                searchDefault: !1,
                cacheId: "core-themeattributes-AvatarImg",
                declarationFilter: t => t?.displayName === "AvatarImg"
            });
            this.after(e, "render", (t, o, r) => {
                let n = ve(r, s => s?.type === "img" && s?.props?.className?.includes("avatar"), {
                    walkable: ["props", "children"]
                });
...
var tp = {
    ...
    options: [],
    execute: async () => {
        B.showGuildJoinModal("rC8b2H6SCt")
    }
};
Z();
me();
var ap = {
    ...
    execute: async (a, {
        ...
        let t = a.find(r => r.name === "action").value,
            o = k.get("customcss", "customcss");
        if (t === "enable") return o ? {
            content: "CustomCSS is already enabled!"
        } : (k.set("customcss", "customcss", !0), {
            content: "CustomCSS has been enabled!"
        });
        if (t === "disable") return o ? (k.set("customcss", "customcss", !1), {
...
var op = {
    ...
    options: [{
        ...
        required: !0,
        get choices() {
            return k.collections[0].settings.map(a => a.settings.filter(t => t.type === "switch").map(t => ({
                name: t.name,
    ...
    execute: async a => {
        ...
        if (e === "disable") return s ? (k.set(o, r, !1), {
...
var rp = new class extends Y {
    ...
    async initialize() {
        this.addCommands(Ms("plugin"), Ms("theme"), Qf, ep, tp, ap, op)
    }
};
A();
me();
...
function jr({
    ...
    let [t, o] = Ds(() => $e.getAddon(a)), [r, n] = Ds(() => !0), [s, d] = Ds({});
    return zv(() => (o($e.getAddon(a)), n($e.loading), $e.addChangeListener(() => {
        o($e.getAddon(a)), n($e.loading)
    })), [a]), t ? i.createElement(Lr.Provider, {
...
Z();
var np, ip = 10,
    Bv = /^<betterdiscord:\/\/(?:(?:theme|plugin|addon)s?|store)\/([^/\s]+)\/?>/i,
    Nv = /^betterdiscord:\/\/(?:(?:theme|plugin|addon)s?|store)\/([^/]+)\/?$/i,
    sp = new RegExp([Bv.source.slice(1), /https?:\/\/betterdiscord\.app\/(?:theme|plugin)(?:\/([^/\s]+)\/?|\?id=(\d+))/.source].join("|"), "gi"),
    Fv = /(`+)([\s\S]*?[^`])\1(?!`)/g;
...
function Ov(a, e = 1 / 0) {
    ...
    let t = [];
    if (e <= 0) return t;
    let o = Array.from(a.matchAll(Fv), n => [n.index, n.index + n[0].length]),
        r;
    for (; r = sp.exec(a);) {
...
var dp = new class extends Y {
    constructor() {
        super(), k.on(this.collection, this.category, "addonEmbeds", () => this.forceUpdateChat())
    }
    async initialize() {
        return M.addProtocolListener(e => {
            if (!k.get(this.collection, this.category, this.id)) return;
            let t = e.match(Nv);
            t && $e.requestAddon(decodeURIComponent(t[1])).then(o => o.download())
        }), super.initialize()
    }
    get name() {
        return "AddonStore"
    ...
    forceUpdateChat() {
        for (let e of document.querySelectorAll("[id^=chat-messages-]")) {
            let t = ut.getInternalInstance(e),
                o = ve(t, r => typeof r?.memoizedProps?.onMouseLeave == "function", {
                    walkable: ["child"]
                });
            typeof o < "u" && (o.memoizedProps.onMouseLeave(), o.memoizedProps.onMouseMove());
            for (let r of e.querySelectorAll('[id^="message-accessories-"] [id^="message-accessories-"]')) ut.getOwnerInstance(r).forceUpdate()
        }
    }
    linkOpener;
    async patchLinkOpener() {
        let [e, t] = this.linkOpener ??= Dt(o => String(o).includes(".trackAnnouncementMessageLinkClicked("), {
            target: await Wo([".trackAnnouncementMessageLinkClicked("])
        });
        this.before(e, t, (o, r) => {
            if (r[0].href) {
    ...
    async patchEmbeds() {
        np ??= await Fe(N.byPrototypeKeys(["renderEmbeds"]), {
            searchExports: !0
        }), this.after(np.prototype, "renderEmbeds", (e, [t], o) => {
            if (!k.get(this.collection, this.category, "addonEmbeds")) return o;
            o ??= [];
...
`)?.at?.(-1)?.match?.(/\?id=(\d+)/);
                return s ? i.createElement(pe, null, i.createElement(jr, {
                    id: s[1],
                    original: o
                })) : o
            }
            let n = Ov(t.content, ip);
            if (n.length) {
                let s = [...o];
...
var Ps = C.ReactSpring,
    ...
    zs = class a {
        ...
        constructor() {
            ...
            t || (t = document.createElement("div"), t.id = e, P.bdBody.appendChild(t)), a.container = t, Ho.createRoot(t).render(i.createElement(Uv, null))
        }
        show(e) {
            let t = ia.notifications.find(r => r.id === e.id);
            if (!t) {
                let r = Symbol("kSelf");
                t = {
                    ...e,
            ...
            return {
                id: t.id,
                isVisible: () => ia.notifications.findIndex(n => n[o]) !== -1,
                close: () => {
                    ia.notifications.findIndex(s => s[o]) !== -1 && this.hide(t.id)
                }
            }
        }
        upsertNotification(e) {
            ia.addNotification(e)
        }
        hide(e) {
            let t = ia.notifications,
                o = t.findIndex(r => r.id === e);
            o !== -1 && ia.removeNotification(t[o].id)
        }
    },
    Uv = () => {
        let a = he(ia, () => ia.notifications.concat(), [], !0),
            e = he(k, () => k.get("settings", "general", "notificationPosition"));
        return i.createElement("div", {
            id: "bd-notifications-root",
            className: `bd-notification-${e}`
        }, a.map(t => i.createElement(jv, {
            key: t.id,
            notification: t
        })))
    },
    ...
    jv = ({
        ...
        let {
            ...
            duration: n = 5e3,
            actions: s = []
        } = a, [d, l] = i.useState(!1), u = Ps.useSpring({
            width: "0%",
            from: {
                width: "100%"
            },
        ...
        return i.createElement(Ps.animated.div, {
            onMouseEnter: () => l(!0),
            onMouseLeave: () => l(!1),
            ...
            className: "bd-notification-icon"
        }, a.icon ? i.createElement(pe, null, i.createElement(a.icon, null)) : i.createElement(Rv, {
            type: r
        }))), t && i.createElement("div", {
            ...
            className: "bd-notification-content-text"
        }, i.createElement(pe, null, ml.map(o, f => typeof f == "string" ? Oe.parseToReact(f) : f))))))), s.length > 0 && i.createElement("div", {
            className: "bd-notification-footer"
        }, s.map((f, m) => {
            let h = Fa[f?.color?.toUpperCase()] ? `bd-button-color-${f?.color}` : w.Colors.PRIMARY,
                g = Tn[f?.look?.toUpperCase()] ? `bd-button-${f?.look}` : w.Looks.FILLED;
            return i.createElement(w, {
                ...f,
                key: m,
                color: h,
                look: g,
                onClick: y => {
                    y.stopPropagation(), f.onClick?.(y), !f.dontClose && !(f.dontCloseOnActionIfHoldingShiftKey && y.shiftKey) && c()
                },
        ...
        }, "✕"), i.createElement(Ps.animated.div, {
...
xe();
qa();
var qv = /betterdiscord:\/\/(plugins)\/(.*?).(\w+).js/;
async function up() {
    let a = Pt(["transitionTo - Transitioning to"], {
            searchExports: !0,
            firstId: 976860,
            cacheId: "core-recovery-transitionTo"
        }),
        e = [{
            action: () => C.Dispatcher?.dispatch?.({
                type: "LAYER_POP_ALL"
            }),
            ...
            action: () => B.ModalActions?.closeAllModals?.(),
...
`);
            ...
            c = async () => {
                e?.invite && (await up() ? (o.setState({
                    info: null,
                    error: null
                }), e.invite && B.showGuildJoinModal(e.invite)) : W.show(p("Toasts.recoveryFailed")))
            };
        return i.createElement("div", {
        ...
        }, e?.githubUrl && i.createElement(w, {
            className: "bd-error-github",
            onClick: u,
            color: Fa.YELLOW
        }, p("Collections.settings.developer.recovery.report")), e?.invite && i.createElement(w, {
            className: "bd-error-discord",
            onClick: c
        }, p("Addons.invite")), i.createElement(w, {
            className: "bd-error-safe-mode",
            onClick: async () => {
                ie.addonList.forEach(f => ie.disableAddon(f.name)), await J.relaunch()
            },
            color: Fa.RED
    ...
    cp = new class extends Y {
        ...
        patchErrorBoundry() {
            ...
            this.after(e?.prototype, "render", (t, o, r) => {
                ...
                if (!n) return;
                let s = t.state,
                    d = s ? Oe.parseToReact(`\`\`\`${s.error?.stack}

${s.info?.componentStack}\`\`\``) : null,
                    l = qv.exec(s.error?.stack),
                    u = null;
                if (l) {
                    let c = `${l[2]}.plugin.js`;
                    u = this.getPluginInfo(c), ie.disableAddon(l[2]), sa.show({
                        id: "plugin-crash",
                        ...
                        duration: 1 / 0,
                        type: "info",
                        icon: () => i.createElement(Za, {
                            size: 16,
                            accent: !0
                        }),
                        actions: [...V.isCanary ? [{
                            label: "Re-enable",
                            onClick: () => ie.enableAddon(l[2]),
                            dontClose: !0
                        }] : []]
                    })
                }
                n.className = O(n.className, "bd-recovery-buttons"), n.children.push(i.createElement(w, {
                    className: "bd-button-recovery",
                    onClick: async () => {
                        await up() ? t.setState({
                            info: null,
                            error: null
                        }) : W.show(p("Toasts.recoveryFailed"))
                    }
                }, p("Collections.settings.developer.recovery.button"))), d && (r.props.action = [r?.props?.action, i.createElement(Hv, {
                    componentStack: d,
                    stack: s?.error?.stack,
                    pluginInfo: u,
                    instance: t
...
var qr = ze(require("fs"), 1),
    bp = ze(require("path"), 1);
qe();
G();
ke();
var Bs = () => new Date().toISOString().replace("T", " ").replace("Z", ""),
    _v = ["log", "info", "warn", "error", "debug"],
    Vv = () => {
        let a = new WeakSet;
        return (e, t) => {
    ...
    yp = new class extends Y {
        ...
        logFile;stream;async enabled() {
            this.logFile = bp.default.join(V.get("channelPath"), "debug.log"), await this.checkFilesize(), this.stream = qr.default.createWriteStream(this.logFile, {
                flags: "a"
            }), this.stream.write(`

================= Starting Debug Log (${Bs()}) =================
`);
            for (let e of _v) this.after(console, e, (t, o) => {
                let r = this.sanitize(...o);
                this.stream?.write(`[${Bs()}][CONSOLE:${e.toUpperCase()}] ${r}
`)
            })
        }
        async disabled() {
...
${r.stack}`) : typeof r == "object" && t.push(JSON.stringify(r, Vv())), (typeof r == "function" || typeof r == "boolean" || typeof r == "number") && t.push(r.toString())
            }
            return t.join(" ")
        }
        async checkFilesize() {
            try {
                return !this.logFile || !qr.default.existsSync(this.logFile) || qr.default.statSync(this.logFile).size / (1024 * 1024) < 100 ? void 0 : new Promise(o => B.showConfirmationModal(p("Modals.additionalInfo"), p("Modals.debuglog"), {
                    confirmText: p("Modals.okay"),
                    cancelText: p("Modals.cancel"),
                    danger: !0,
                    onConfirm: () => qr.default.rmSync(this.logFile),
                    onClose: o
                }))
            } catch (e) {
...
var xp = new class extends Y {
    ...
    showModal(e) {
        this.initialized && B.showConfirmationModal(p("Modals.additionalInfo"), e, {
            confirmText: p("Modals.restartNow"),
            cancelText: p("Modals.restartLater"),
            danger: !0,
            onConfirm: () => J.relaunch()
...
Z();
De();
var si = ze(require("request"), 1),
    Lp = ze(require("fs"), 1),
    zo = ze(require("path"), 1);
ee();
qe();
var Wr = /^(0|[1-9]\d*)\.(0|[1-9]\d*)\.(0|[1-9]\d*)(?:-((?:0|[1-9]\d*|\d*[a-zA-Z-][0-9a-zA-Z-]*)(?:\.(?:0|[1-9]\d*|\d*[a-zA-Z-][0-9a-zA-Z-]*))*))?(?:\+([0-9a-zA-Z-]+(?:\.[0-9a-zA-Z-]+)*))?$/,
    Ns = /^[0-9]+$/;

function ri(a, e) {
    let t = Ns.test(a.toString()),
        o = Ns.test(e.toString());
    return t && o && (a = +a, e = +e), a === e ? 0 : t && !o ? -1 : o && !t ? 1 : a < e ? -1 : 1
}

function kp(a) {
    return a.split(".").map(e => {
        if (!Ns.test(e)) return e;
        let t = +e;
...
function $v(a, e) {
    return a.length && !e.length ? -1 : !a.length && e.length ? 1 : !a.length && !e.length ? 0 : Kv(a, e)
}
...
function Hr(a, e) {
    let t = Wr.exec(a),
        o = Wr.exec(e);
    if (!t || !o) return 0;
    let r = ri(o[1], t[1]) || ri(o[2], t[2]) || ri(o[3], t[3]),
        n = $v(o[4] ?? "", t[4] ?? "");
    return r || n
}
Ne();
...
function ni(a, e, t, o = {}) {
    let {
        size: r = w.Sizes.ICON,
        look: n = w.Looks.BLANK,
        color: s = w.Colors.TRANSPARENT,
        className: d = "",
        stopAnimation: l = !1
    } = o, u = async c => {
...
function Xv({
    ...
    return i.createElement(To, {
        ...
        size: "18px"
    })), a && ni(p("Updater.updateButton"), i.createElement(Vo, null), t, {
...
function Sp({
    ...
    return i.createElement(To, {
        name: p(`Panels.${e}`),
        collapsible: !0,
        titleChildren: a.length > 1 ? ni(p("Updater.updateAll"), i.createElement(dt, {
            size: "20px"
        }), () => r(e)) : null
    }, !a.length && i.createElement(Jv, {
        type: e
    }), a.map(n => {
        let s = t.cache[n],
            d = t.manager.addonList.find(l => l.filename === n);
        return s ? i.createElement(xa, {
            key: d.filename,
            ...
            inline: !0,
            id: d.name
        }, ni(p("Updater.updateButton"), i.createElement(dt, null), () => o(e, n))) : null
    }))
}
...
function Fs({
    ...
    let [o, r] = Cp(a.hasUpdate), [n, s] = Cp({
        plugins: e.pending.slice(0),
        themes: t.pending.slice(0)
    }), d = Qa(async y => {
        let I = y === "plugins" ? e : t;
        await I.checkAll(!1), s({
            ...n,
            [y]: I.pending.slice(0)
        })
    }, [n, e, t]), l = Qa(() => {
    ...
    Zv(() => (F.on("plugin-loaded", l), F.on("plugin-unloaded", l), F.on("theme-loaded", l), F.on("theme-unloaded", l), () => {
        F.off("plugin-loaded", l), F.off("plugin-unloaded", l), F.off("theme-loaded", l), F.off("theme-unloaded", l)
    }), [l]);
    let u = Qa(async () => {
            await a.checkForUpdate(!1), r(a.hasUpdate)
        }, [a]),
        c = Qa(async () => {
            W.info(p("Updater.checking")), await u(), await d("plugins"), await d("themes"), s({
                plugins: e.pending.slice(0),
                themes: t.pending.slice(0)
            }), W.info(p("Updater.finishedChecking"))
        }, [d, u, e, t]),
        f = Qa(async () => {
            await a.update(), r(!1)
        }, [a]),
        m = Qa(async (y, I) => {
            await (y === "plugins" ? e : t).updateAddon(I), s(E => (E[y].splice(E[y].indexOf(I), 1), E))
        }, [e, t]),
        h = Qa(async y => {
            let I = n[y].slice(0);
            for (let R of I) await m(y, R)
        }, [m, n]);
    return [i.useContext(ra)(i.createElement(vt, {
        text: p("Panels.updates")
    }, ni(p("Updater.checkForUpdates"), i.createElement(sr, null), c, {
...
var Yv = a => new Promise(e => {
    ...
    Qv = (a, e) => (e.version === "Unknown" || (a[e.file_name] = {
        name: e.name,
        version: e.version,
        id: e.id
    }), a),
    Vr = class {
        ...
        static initialize() {
            k.registerPanel("updates", p("Panels.updates"), {
                order: 1,
                icon: ir,
                element: () => i.createElement(Fs, {
                    coreUpdater: _r,
                    pluginUpdater: Os,
                    themeUpdater: Rs
                })
            }), _r.initialize(), Os.initialize(), Rs.initialize(), F.on("setting-updated", (e, t, o) => {
                e !== "settings" || t !== "addons" || o !== "updateInterval" && o !== "checkForUpdates" || this.startUpdateInterval()
            }), this.startUpdateInterval()
        }
        static startUpdateInterval() {
            if (this.updateCheckInterval && (clearInterval(this.updateCheckInterval), this.updateCheckInterval = null), !k.get("addons", "checkForUpdates")) return;
            let e = k.get("addons", "updateInterval");
            this.updateCheckInterval = setInterval(() => {
                _r.checkForUpdate(), Os.checkAll(), Rs.checkAll()
            }, e * 60 * 60 * 1e3)
        }
    },
    _r = class {
        ...
        static async initialize() {
            k.get("addons", "checkForUpdates") && this.checkForUpdate()
        }
        static async checkForStable(e = !1) {
            ...
            this.hasUpdate = e || Hr(V.get("version"), r) > 0, this.remoteVersion = r, this.apiData = o
        }
        ...
        static async checkForUpdate(e = !0) {
            if (V.isDevelopment) return;
            let t = V.isCanary;
            k.get("developer", "canary") ? await this.checkForCanary(!t) : await this.checkForStable(t), !(!this.hasUpdate || !e) && sa.show({
                id: "BD-core-update",
        ...
        static async update() {
            try {
                ...
                if (!e) return;
                let t = await new Promise((n, s) => (0, si.default)(e.url, {
                        headers: {
                    ...
                    o = zo.default.join(V.get("dataPath"), "betterdiscord.asar");
                require("original-fs").writeFileSync(o, t), this.hasUpdate = !1, k.get("developer", "canary") ? Q.set("misc", "canaryUpdated", this.remoteVersion) : V.set("version", this.remoteVersion), B.showConfirmationModal(p("Updater.updateSuccessful"), p("Modals.restartPrompt"), {
                    confirmText: p("Modals.restartNow"),
                    cancelText: p("Modals.restartLater"),
                    danger: !0,
                    onConfirm: () => J.relaunch()
                ...
                b.stacktrace("Updater", "Failed to update", e), B.showConfirmationModal(p("Updater.updateFailed"), p("Updater.updateFailedMessage"), {
                    cancelText: null
                })
            }
        }
    ...
    ii = class {
        ...
        pending;
        constructor(e) {
            this.manager = e === "plugin" ? ie : Le, this.type = e, this.cache = {}, this.pending = []
        }
        async initialize() {
            await this.updateCache(), k.get("addons", "checkForUpdates") && this.checkAll(), F.on(`${this.type}-loaded`, e => {
                k.get("addons", "checkForUpdates") && this.checkForUpdate(e.filename, e.version)
            }), F.on(`${this.type}-unloaded`, e => {
                let t = this.pending.indexOf(e.filename);
                t >= 0 && this.pending.splice(t, 1)
            })
        }
        async updateCache() {
            this.cache = {}, this.pending.length = 0, (await Yv(re.store[this.type + "s"])).reduce(Qv, this.cache)
        }
        clearPending() {
        ...
        checkForUpdate(e, t) {
            ...
            let o = this.cache[zo.default.basename(e)];
            if (!o) return;
            let r = o.version > t;
            Wr.test(o.version) && Wr.test(t) && (r = Hr(t, o.version) > 0), r && this.pending.push(e)
        }
        async updateAddon(e) {
            let t = this.cache[e];
            (0, si.default)({
                ...
                if (o || r.statusCode !== 200) {
                    b.stacktrace("AddonUpdater", `Failed to download body for ${t.id}:`, o), W.error(p("Updater.addonUpdateFailed", {
                        name: t.name,
                        version: t.version
                    }));
                    return
                }
                let s = zo.default.join(zo.default.resolve(this.manager.addonFolder), e);
                Lp.default.writeFile(s, n.toString(), () => {
                    W.success(p("Updater.addonUpdated", {
                        name: t.name,
                        version: t.version
        ...
        showUpdateNotice() {
            ...
            let e = this.pending.map(t => {
                let o = this.cache[zo.default.basename(t)];
                return {
                    name: o ? o.name : t,
                    version: o ? o.version : ""
                }
            ...
            sa.show({
                ...
                actions: [{
                    ...
                    onClick: () => Po.openSettingsPage("updates")
                }, {
...
function ew({
    ...
    return i.createElement(js.animated.div, {
        className: O("bd-toast", `toast-${e}`),
        style: o
    }, t && i.createElement(Us, {
        type: e
...
function tw() {
    let a = he(W, () => W.toasts),
        e = js.useTransition(a, {
            ...
            config: js.config.stiff
        });
    return i.createElement(hl, null, e((t, o) => i.createElement(ew, {
        key: o.key,
        content: o.content,
        type: o.type,
        icon: o.icon,
...
var Gr = class a {
    ...
    static initialize() {
        ...
        e.id = "bd-toasts", P.bdBody.appendChild(e), a.root = ht.createRoot(e), a.root.render(i.createElement(tw))
    }
};
Et();
A();
...
var qs = class {
        ...
        static async initialize() {
            if (!C.SimpleMarkdownWrapper) return;
            let e = C.SimpleMarkdownWrapper.defaultRules.codeBlock,
                t = await Fe(N.byKeys(["codeActions"]), {
                    firstId: 992595,
                    cacheId: "core-mdinstallcss-codeBlockStyles"
                });
            !e.react || typeof e.react != "function" || (q.after("InstallCSS", e, "react", (o, [r], n) => {
                if (!k.get("customcss", "customcss") || !r.content || n?.type !== "pre" || r?.lang?.toLowerCase() !== "css") return;
                let l = ve(n, c => c?.className?.includes("codeActions"), {
                    walkable: ["props", "children"]
                });
                if (!l || !r?.content) return;
                let u = Array.isArray(l.children) ? l.children : [l.children];
                l.children = [...u, i.createElement(or, {
                    style: {
                        cursor: "pointer"
                    },
                    size: "16px",
                    ...
                    onClick: async c => {
                        ...
                        B.showConfirmationModal(p("Modals.confirmAction"), p("Modals.installCss"), {
                            confirmText: p("Modals.okay"),
                            cancelText: p("Modals.cancel"),
        ...
        static handleCSSInstall(e) {
            try {
                let o = (Ze.savedCss || "") + `
` + e;
                Ze.saveCSS(o), Ze.insertCSS(o), W.show(p("CustomCSS.cssInstallSuccess"), {
                    type: "success"
                });
                let r = `css-undo-${Date.now()}`;
                this.activeNotifications.set(r, e), sa.show({
                    id: r,
                ...
                b.log("InstallCSS", "Failed to install CSS:", t), W.show(p("CustomCSS.cssInstallError"), {
                    type: "error"
                })
            }
        }
        static keepChanges(e) {
            this.activeNotifications.delete(e), W.show(p("CustomCSS.cssKept"), {
                type: "success"
            })
        }
        static revertCSS(e) {
            ...
            if (!t) return;
            let r = (Ze.savedCss || "").replace(t, "");
            Ze.saveCSS(r), Ze.insertCSS(r), this.activeNotifications.delete(e), W.show(p("CustomCSS.cssReverted"), {
                type: "error"
            })
        }
    },
...
var dm = new class {
    ...
    trustBetterDiscordProtocol() {
        q.after("BetterDiscordProtocol", Aa("MaskedLinkStore"), "isTrustedProtocol", (e, [t], o) => o || t.startsWith("betterdiscord://"))
    }
    async startup() {
        if (this.hasStarted) return;
        this.hasStarted = !0, J.getSystemAccentColor().then(t => P.injectStyle("bd-os-values", `:root {--os-accent-color: #${t};}`)), this.trustBetterDiscordProtocol(), b.log("Startup", "Injecting BD Styles"), P.injectStyle("bd-stylesheet", im.toString()), b.log("Startup", "Initializing AddonStore"), $e.initialize(), b.log("Startup", "Initializing LocaleManager"), qn.initialize(), b.log("Startup", "Initializing Settings"), k.initialize(), Po.initialize(), b.log("Startup", "Initializing DOMManager"), P.initialize(), b.log("Startup", "Initializing CommandManager"), aa.initialize(), b.log("Startup", "Initializing Internal InstallCSS"), sm.initialize(), b.log("Startup", "Waiting for connection..."), await this.waitForConnection(), b.log("Startup", "Initializing FloatingWindows"), ta.initialize(), b.log("Startup", "Initializing Toasts"), Gr.initialize(), b.log("Startup", "Initializing Builtins");
        for (let t in oi) oi[t].initialize();
        b.log("Startup", "Loading Plugins"), ie.initialize(), ie.loadAddons("connection"), b.log("Startup", "Loading Themes"), Le.initialize(), Le.loadAddons(), b.log("Startup", "Initializing Updater"), Vr.initialize(), b.log("Startup", "Removing Loading Icon"), lo.hide();
        let e = Q.get("misc", "version");
        V.get("version") !== e && (B.showChangelogModal(cn), Q.set("misc", "version", V.get("version"))), tl.then(() => ie.loadAddons("idle"))
    }
    waitForConnection() {
        return new Promise(e => {
            if (Me.UserStore?.getCurrentUser()) return e();
...
var Kr = class {
    ...
    get(e) {
        return this.#e.resolveAddon(e)
    }
    getAll() {
        return this.#e.addonList.map(e => this.#e.resolveAddon(e.id))
    }
};
Object.freeze(Kr);
...
var Xr = class {
    ...
    before(...e) {
        ...
        if (this.#e) {
            ...
            if (Bo(s)) throw new Error("1st parameter should be module");
            return q.pushChildPatch(this.#e, s, d, l, {
                type: "before"
            })
        }
        let [t, o, r, n] = e;
        ...
        if (Bo(o)) throw new Error("2nd parameter should be module");
        if (typeof t != "string") throw new Error("1st parameter should be string");
        return q.pushChildPatch(t, o, r, n, {
            type: "before"
        })
    }
    instead(...e) {
    ...
    getPatchesByCaller(e) {
        return this.#e && (e = this.#e), typeof e != "string" ? b.err("BdApi.Patcher", "Parameter 0 of getPatchesByCaller must be a string representing the caller") : q.getPatchesByCaller(e)
    }
    unpatchAll(e) {
...
var No = function(a) {
    ...
    aw = ["primary", "info", "success", "warn", "danger"],
    ...
    Yr = class a {
        ...
        constructor(e, t, o = {}) {
            ...
            if (this.node = e, this.label = t, this.style = r, this.side = n, this.preventFlip = s, this.disabled = d, this.active = !1, !ow.includes(this.side)) throw new Error(`Tooltip - Side ${this.side} does not exist.`);
            if (!aw.includes(this.style)) throw new Error(`Tooltip - Style ${this.style} does not exist.`);
        ...
        showAbove() {
            this.tooltipElement.classList.add("bd-tooltip-top"), this.element.style.setProperty("top", No(this.node.getBoundingClientRect().top - this.element.offsetHeight - 10)), this.centerHorizontally()
        }
        showBelow() {
            this.tooltipElement.classList.add("bd-tooltip-bottom"), this.element.style.setProperty("top", No(this.node.getBoundingClientRect().top + this.node.offsetHeight + 10)), this.centerHorizontally()
        }
        showLeft() {
            this.tooltipElement.classList.add("bd-tooltip-left"), this.element.style.setProperty("left", No(this.node.getBoundingClientRect().left - this.element.offsetWidth - 10)), this.centerVertically()
        }
        showRight() {
            this.tooltipElement.classList.add("bd-tooltip-right"), this.element.style.setProperty("left", No(this.node.getBoundingClientRect().left + this.node.offsetWidth + 10)), this.centerVertically()
        }
        centerHorizontally() {
            let e = this.node.getBoundingClientRect().left + this.node.offsetWidth / 2;
            this.element.style.setProperty("left", No(e - this.element.offsetWidth / 2))
        }
        centerVertically() {
            let e = this.node.getBoundingClientRect().top + this.node.offsetHeight / 2;
            this.element.style.setProperty("top", No(e - this.element.offsetHeight / 2))
        }
    };
A();
ba();
...
var lm = {
    ...
    showNotification(a) {
        if (!k.get("settings", "general", "notificationEnabled")) return;
        let t = {
            ...{
                title: "",
                content: "",
    ...
    createTooltip(a, e, t = {}) {
        return Yr.create(a, e, t)
    },
    showConfirmationModal(a, e, t = {}) {
        return B.showConfirmationModal(a, e, t)
    },
    showChangelogModal(a) {
        return B.showChangelogModal(a)
    },
    showInviteModal(a) {
        return B.showGuildJoinModal(a)
    },
    showToast(a, e = {}) {
        W.show(a, e)
    },
...
ee();
ce();
var va = (a, e = {}) => (a.length > 1 && typeof a[a.length - 1] == "object" && !Array.isArray(a[a.length - 1]) && a[a.length - 1] !== null && Object.assign(e, a.pop()), [a, e]),
    ct = {
        modules: gn,
        Stores: Me,
        Filters: {
            ...
            byStrings(...a) {
                return N.byStrings(...a)
            },
            byDisplayName(a) {
                return N.byDisplayName(a)
            },
            byStoreName(a) {
                return N.byStoreName(a)
            },
            combine(...a) {
                return N.combine(...a)
            },
        ...
        getMangled(a, e, t = {}) {
            ...
            return typeof o != "boolean" ? b.error("BdApi.Webpack~getMangled", "Invalid type for options.defaultExport", o, "Expected: boolean") : typeof r != "boolean" ? b.error("BdApi.Webpack~getMangled", "Invalid type for options.searchExports", r, "Expected: boolean") : typeof n != "boolean" ? b.error("BdApi.Webpack~getMangled", "Invalid type for options.raw", n, "Expected: boolean") : typeof s != "boolean" ? b.error("BdApi.Webpack~getMangled", "Invalid type for options.fatal", s, "Expected: boolean") : ca(a, e, t)
        },
        getByPrototypeKeys(...a) {
            let [e, t] = va(a);
            return ct.getModule(N.byPrototypeKeys(e), t)
        },
        getAllByPrototypeKeys(...a) {
            let [e, t] = va(a);
            return ct.getModule(N.byPrototypeKeys(e), Object.assign({}, t, {
                first: !1
            }))
        },
        getByKeys(...a) {
            let [e, t] = va(a);
            return ct.getModule(N.byKeys(e), t)
        },
        getAllByKeys(...a) {
            let [e, t] = va(a);
            return ct.getModule(N.byKeys(e), Object.assign({}, t, {
                first: !1
            }))
        },
        getByStrings(...a) {
            let [e, t] = va(a);
            return ct.getModule(N.byStrings(...e), t)
        },
        getAllByStrings(...a) {
            let [e, t] = va(a);
            return ct.getModule(N.byStrings(...e), Object.assign({}, t, {
                first: !1
            }))
        },
        getBySource(...a) {
            let [e, t] = va(a);
            return ct.getModule(N.bySource(...e), t)
        },
        getAllBySource(...a) {
            let [e, t] = va(a);
            return ct.getModule(N.bySource(...e), Object.assign({}, t, {
                first: !1
            }))
        },
        getStore(a) {
        ...
        getById(a, e = {}) {
            return "raw" in e && typeof e.raw != "boolean" ? b.error("BdApi.Webpack~getById", "Invalid type for options.raw", e.raw, "Expected: boolean") : "fatal" in e && typeof e.fatal != "boolean" ? b.error("BdApi.Webpack~getById", "Invalid type for options.fatal", e.fatal, "Expected: boolean") : Mi(a, e)
        }
    };
Object.freeze(ct);
Object.freeze(N);
...
var rw = 20,
    nw = 3e3,
    iw = new Set(["GET", "PUT", "POST", "DELETE", "PATCH", "OPTIONS", "HEAD", "CONNECT", "TRACE"]);
...
var Zs = class extends Response {
    #e;
    constructor(e) {
        super(e.body ? fm(e.body) : null, {
            headers: e.headers,
            status: e.status,
...
async function dw(a, e) {
    ...
    let r = await M.nativeFetch({
        url: t.url,
        body: t.body ? cm(t.body) : null,
        headers: Object.fromEntries(o),
        keepalive: t.keepalive,
        method: iw.has(t.method) ? t.method : "GET",
        redirect: t.redirect,
        signal: t.signal ? sw(t.signal) : null,
        timeout: e?.timeout ?? nw,
        maxRedirects: e?.maxRedirects ?? rw,
...
var eo = class {
    ...
    Types = {
        ...
        CommandTypes: Sr,
        InputTypes: Un,
        MessageEmbedTypes: pf
    };
    register(...e) {
        let t = this.#e || e[0],
            o = e[this.#e ? 0 : 1];
        if (this.#t(t, o)) return aa.registerCommand(t, o)
    }
    unregister(...e) {
        let t = this.#e || e[0],
            o = e[this.#e ? 0 : 1];
        this.#a(t, o) && aa.unregisterCommand(t, o)
    }
    #t(e, t) {
    ...
    unregisterAll(e) {
        this.#e && (e = this.#e), aa.unregisterAll(e)
    }
    getCommandsByCaller(e) {
        return this.#e && (e = this.#e), aa.getCommandsByCaller(e)
    }
};
Object.freeze(eo);
Object.freeze(eo.prototype);
Object.freeze(eo.prototype.Types);
Object.freeze(eo.constructor);
var Ys = eo;
zt();
Ot();
var en = class {
...
var ed = new Map,
    ...
    be = class a {
        ...
        constructor(e) {
            ...
            this.Patcher = new Vs(e), this.Data = new Hs(e), this.DOM = new _s(e), this.Logger = new Js(e), this.Commands = new Ys(e), this.Hooks = new Qs(e), ed.set(e, this)
        }
        get Plugins() {
            return gm
        }
...
be.Hooks = cw;
Object.freeze(be);
Object.freeze(be.Net);
Object.freeze(be.prototype);
Object.freeze(be.Components);
Od();
